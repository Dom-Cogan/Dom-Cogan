...
// .wrangler/tmp/bundle-m29WFy/checked-fetch.js
...
// .wrangler/tmp/pages-KWvfC1/bundledWorker-0.24269552289432994.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-WIlFJT/checked-fetch.js"() {
    "use strict";
...
function Z2(n, e) {
  const s = e == null ? void 0 : e.mapper, t = n.symbolMapper ? n.symbolMapper : (i) => {
    ...
    if (s) {
      ...
      if (!a) {
        if (r === he2)
          return [r, ""];
        if ((c = globalThis.__qwik_reg_symbols) == null ? void 0 : c.has(r))
          return [i, "_"];
  ...
  return { isServer: true, async importSymbol(i, c, r) {
    var g;
    const a = D2(r), m = (g = globalThis.__qwik_reg_symbols) == null ? void 0 : g.get(a);
    if (m)
      return m;
    let p = String(c);
    p.endsWith(".js") || (p += ".js");
    const b = je2(p);
    if (!(r in b))
      throw new Error(`Q-ERROR: missing symbol '${r}' in module '${p}'.`);
    return b[r];
...
function ke2(n, e, s) {
  if (!s)
    return [];
  const t = e.prefetchStrategy, o = ee2(e);
  if (t !== null) {
...
function xe2(n, e, s) {
  const t = [], o = n == null ? void 0 : n.qrls, { mapper: i, manifest: c } = e, r = /* @__PURE__ */ new Map();
  if (Array.isArray(o))
    for (const a of o) {
...
function w(n) {
  const e = [], s = (t) => {
    if (Array.isArray(t))
      for (const o of t)
        e.includes(o.url) || (e.push(o.url), s(o.imports));
  };
  return s(n), e;
}
function Ne2(n) {
  ...
  return c.sort((r, a) => a[1] - r[1]), c.slice(0, 5).filter((r) => r[1] > i).map((r) => r[0]);
}
function De2(n, e, s) {
  const t = Te2(n == null ? void 0 : n.implementation), o = [];
  return t.prefetchEvent === "always" && ze2(o, e, s), t.linkInsert === "html-append" && Se2(o, e, t), t.linkInsert === "js-append" ? Oe2(o, e, t, s) : t.workerFetchInsert === "always" && Ie2(o, e, s), o.length > 0 ? v$(he, { children: o }) : null;
}
function ze2(n, e, s) {
  const t = Ne2(e);
  for (const o of t)
    n.push(v$("link", { rel: "modulepreload", href: o, nonce: s }));
...
function Se2(n, e, s) {
  const t = w(e), o = s.linkRel || "prefetch";
  for (const i of t) {
    const c = {};
    c.href = i, c.rel = o, (o === "prefetch" || o === "preload") && i.endsWith(".js") && (c.as = "script"), n.push(v$("link", c, void 0));
  }
}
function Oe2(n, e, s, t) {
  const o = s.linkRel || "prefetch";
  let i = "";
  s.workerFetchInsert === "no-link-support" && (i += "let supportsLinkRel = true;"), i += `const u=${JSON.stringify(w(e))};`, i += "u.map((u,i)=>{", i += "const l=document.createElement('link');", i += 'l.setAttribute("href",u);', i += `l.setAttribute("rel","${o}");`, s.workerFetchInsert === "no-link-support" && (i += "if(i===0){", i += "try{", i += `supportsLinkRel=l.relList.supports("${o}");`, i += "}catch(e){}", i += "}"), i += "document.body.appendChild(l);", i += "});", s.workerFetchInsert === "no-link-support" && (i += "if(!supportsLinkRel){", i += z(), i += "}"), s.workerFetchInsert === "always" && (i += z()), n.push(v$("script", { type: "module", "q:type": "link-js", dangerouslySetInnerHTML: i, nonce: t }));
}
function Ie2(n, e, s) {
  let t = `const u=${JSON.stringify(w(e))};`;
  t += z(), n.push(v$("script", { type: "module", "q:type": "prefetch-worker", dangerouslySetInnerHTML: t, nonce: s }));
}
function Te2(n) {
  return { ...Le2, ...n };
}
var Le2 = { linkInsert: null, linkRel: null, workerFetchInsert: null, prefetchEvent: "always" };
var Fe2 = "<!DOCTYPE html>";
async function Be2(n, e) {
  var E3, K4, Q3;
  let s = e.stream, t = 0, o = 0, i = 0, c = 0, r = "", a;
  const m = ((E3 = e.streaming) == null ? void 0 : E3.inOrder) ?? { strategy: "auto", maximunInitialChunk: 5e4, maximunChunk: 3e4 }, p = e.containerTagName ?? "html", b = e.containerAttributes ?? {}, g = s, te4 = N2(), ie4 = ee2(e), d = se2(e.manifest);
  function O4() {
    r && (g.write(r), r = "", t = 0, i++, i === 1 && (c = te4()));
  }
  function I3(l) {
    const f2 = l.length;
    t += f2, o += f2, r += l;
  ...
  switch (m.strategy) {
    ...
    case "auto":
      ...
      s = { write(j3) {
        j3 === "<!--qkssr-f-->" ? f2 || (f2 = true) : j3 === "<!--qkssr-pu-->" ? l++ : j3 === "<!--qkssr-po-->" ? l-- : I3(j3), l === 0 && (f2 || t >= (i === 0 ? v3 : A3)) && (f2 = false, O4());
      } };
      break;
  }
  ...
  const T2 = d == null ? void 0 : d.manifest.injections, k3 = T2 ? T2.map((l) => v$(l.tag, l.attributes ?? {})) : [], x2 = ((K4 = e.qwikLoader) == null ? void 0 : K4.include) ?? "auto";
  if ((((Q3 = e.qwikLoader) == null ? void 0 : Q3.position) ?? "bottom") === "top" && x2 !== "never") {
  ...
  const oe4 = N2(), L4 = [];
  let F4 = 0, B3 = 0;
  await g$(n, { stream: s, containerTagName: p, containerAttributes: b, serverData: e.serverData, base: ie4, beforeContent: k3, beforeClose: async (l, f2, A3, v3) => {
    var Y4, U2, G4, J4, $3;
    F4 = oe4();
    const j3 = N2();
    a = await Bi(l, f2, void 0, v3);
    const q3 = [];
    if (e.prefetchStrategy !== null) {
      const _2 = ke2(a, e, d);
      if (_2.length > 0) {
        const M2 = De2(e.prefetchStrategy, _2, (Y4 = e.serverData) == null ? void 0 : Y4.nonce);
        M2 && q3.push(M2);
      }
    }
    const ce4 = JSON.stringify(a.state, void 0, void 0);
    q3.push(v$("script", { type: "qwik/json", dangerouslySetInnerHTML: Ee2(ce4), nonce: (U2 = e.serverData) == null ? void 0 : U2.nonce })), a.funcs.length > 0 && q3.push(v$("script", { "q:func": "qwik/json", dangerouslySetInnerHTML: Ae2(a.funcs), nonce: (G4 = e.serverData) == null ? void 0 : G4.nonce }));
    const ae4 = !a || a.mode !== "static", P4 = x2 === "always" || x2 === "auto" && ae4;
    if (P4) {
      const _2 = V2({ debug: e.debug });
      q3.push(v$("script", { id: "qwikloader", dangerouslySetInnerHTML: _2, nonce: (J4 = e.serverData) == null ? void 0 : J4.nonce }));
    }
    const R2 = Array.from(f2.$events$, (_2) => JSON.stringify(_2));
    if (R2.length > 0) {
      const _2 = (P4 ? "window.qwikevents" : "(window.qwikevents||=[])") + `.push(${R2.join(", ")})`;
      q3.push(v$("script", { dangerouslySetInnerHTML: _2, nonce: ($3 = e.serverData) == null ? void 0 : $3.nonce }));
    }
    return Ke2(L4, l), B3 = j3(), v$(he, { children: q3 });
  }, manifestHash: (d == null ? void 0 : d.manifest.manifestHash) || "dev" }), p !== "html" && s.write("<!--/cq-->"), O4();
  const re4 = a.resources.some((l) => l._cache !== 1 / 0);
  return { prefetchResources: void 0, snapshotResult: a, flushes: i, manifest: d == null ? void 0 : d.manifest, size: o, isStatic: !re4, timing: { render: F4, snapshot: B3, firstFlush: c }, _symbols: L4 };
}
function se2(n) {
  if (n) {
    if ("mapper" in n)
...
var Ee2 = (n) => n.replace(/<(\/?script)/gi, "\\x3C$1");
function Ke2(n, e) {
  var s;
  for (const t of e) {
...
var Ye2 = Un(Lt(Re2, "s_0vphQYqOdZI"));
var Ue2 = () => ft(R$, { children: [xt("head", null, null, [xt("meta", null, { charSet: "utf-8" }, null, 3, null), xt("link", null, { rel: "manifest", href: "/manifest.json" }, null, 3, null), ft(Ye2, null, 3, "vp_0")], 1, null), xt("body", null, { lang: "en" }, [ft(T$, null, 3, "vp_1"), ft(A$, null, 3, "vp_2")], 1, null)] }, 1, "vp_3");
var Ge2 = Un(Lt(Ue2, "s_tntnak2DhJ8"));
function We2(n) {
  return Be2(ft(Ge2, null, 3, "Qb_0"), { manifest: Pe2, ...n, containerAttributes: { lang: "en-us", ...n.containerAttributes } });
}
init_checked_fetch();
init_modules_watch_stub();
init_checked_fetch();
...
var G2 = ["flex", "w-full", "max-h-[100vh]", "justify-center", "overflow-hidden", "scrollbar-hidden"];
var H2 = ["p-4", "flex", "mt-4", "w-full", "flex-col", "h-screen", "rounded-md", "items-center", "shadow-border", "scrollbar-hidden"];
...
var V3 = ["m-2", "italic", "text-2xl", "text-center", "font-semibold", "shadow-header", "text-align: center"];
var F2 = ["m-3", "flex", "rounded", "border-4", "items-center", "border-LIGHT-txtPrimary", "justify-center", "hover:bg-LIGHT-bgSecondary"];
var W2 = ["p-4", "h-1", "rounded", "bg-LIGHT-txtSecondary"];
...
var J2 = Un(Lt(U, "s_PX8yQoK5ags"));
var X2 = async ({ cacheControl: e }) => {
  e({ staleWhileRevalidate: 604800, maxAge: 5 });
};
var $ = () => xt("div", null, { class: G2 }, [xt("div", { class: [["w-1/5", "flex", "justify-end", "items-center", "sm:max-w-[70px]"], ["sm:hidden md:flex"]] }, null, null, 3, null), xt("div", { class: ["flex", "w-4/5", "h-full", "m-4"] }, null, xt("div", null, { class: H2 }, ft(xe, null, 3, "yB_0"), 1, null), 1, null), ft(J2, null, 3, "yB_1")], 1, "yB_2");
var D3 = Un(Lt($, "s_VKFlAWJuVm8"));
var Z3 = Object.freeze(Object.defineProperty({ __proto__: null, default: D3, onGet: X2 }, Symbol.toStringTag, { value: "Module" }));
var C2 = { url: "https://appwrite.domcogan.app/v1", projectId: "6621bd6a00282722c88e", databasesId: "6621bdfa001d92f8fa33", blogCollectionId: "6622e812003c292dedb5", itemCollectionId: "662444e20028c21a42fd", sectionCollectionId: "662451cc003b8feca015" };
var f = new Client();
f.setProject(C2.projectId);
f.setEndpoint(C2.url);
new Databases(f);
var Y2 = (e) => {
...
var le2 = () => {
  ...
  return w$(x$("s_9bX79PSaULI", [e])), xt("div", null, { class: k }, e.blogPosts.length > 0 ? e.blogPosts.map((l) => ft(ee3, { get title() {
    ...
    return l.overview;
  }, [M]: { title: ii(l, "title"), id: ii(l, "id"), description: ii(l, "overview") } }, 3, l.id)) : ft(S, { message: "list of blogs", [M]: { message: M } }, 3, "B0_0"), 1, "B0_1");
};
...
var re2 = () => {
  ...
  }, [M]: { text: y$((s) => s.blogPost.title, [o], "p0.blogPost.title") } }, 3, "4y_0"), o.blogPost.sections.map((s) => xt("div", null, { class: A2 }, s.pageSections.map((u) => xt("div", { class: [u.type === "header" ? V3 : u.type === "break" ? W2 : ""] }, null, ci(u, "content"), 1, u.type)), 1, s.id))] }, 1, "4y_1") : ft(S, { message: "blog", [M]: { message: M } }, 3, "4y_2"), 1, "4y_3");
};
...
var xe3 = () => xt("div", null, { class: L2 }, [xt("h1", null, { class: ["p-4", "text-center", "text-6xl", "font-extrabold"] }, "Hello & Welcome", 3, null), xt("p", null, { class: O2 }, "First off, thank you for visiting. My name is Dom Cogan, and this is my portfolio website. I did not attend college. In my spare time, I love learning new skills, I've taught myself Flutter, Qwik, Next.js, and CSS.", 3, null), xt("div", null, { class: P2 }, ft(ge3, { text: "Blog", link: "blog", [M]: { text: M, link: M } }, 3, "Vi_0"), 1, null)], 1, "Vi_1");
...
var be3 = Object.freeze(Object.defineProperty({ __proto__: null, _auto_row: P2, default: me2, head: fe2 }, Symbol.toStringTag, { value: "Module" }));
var _e2 = [];
var v = () => Z3;
var he3 = [["blog/", [v, () => se3], "/blog/", ["q-956IC5Hh.js", "q-C0zrKRXq.js"]], ["blog/[id]/", [v, () => ue2], "/blog/[id]/", ["q-956IC5Hh.js", "q-0TEdWqZE.js"]], ["[...home]", [() => be3], "/[...home]", ["q-D4Z1dQuX.js"]]];
var ve3 = [];
var we3 = true;
var pe2 = "/";
var ye2 = true;
var Ce3 = { routes: he3, serverPlugins: _e2, menus: ve3, trailingSlash: we3, basePathname: pe2, cacheModules: ye2 };
...
var je3 = (e, t, n, r, a) => {
  ...
  if (e && V4(i, s, o, e, l, n), t) {
    const c = t[0];
    r && (n === "POST" || n === "PUT" || n === "PATCH" || n === "DELETE") && o.unshift(Ye3), l && (n === "POST" && o.push(Xe2), o.push(Ge3), o.push(Ee3)), o.push(qe2), V4(i, s, o, t[2], l, n), l && (o.push((d) => {
...
function Be3(e, t) {
  return async (n) => {
    ...
    const { method: r } = n, a = I2(n), i = Q2(n) === "dev", s = n[L3];
...
async function Xe2(e) {
  ...
  if (t && e.request.headers.get("X-QRL") === t && e.request.headers.get("Content-Type") === "application/qwik-json") {
    e.exit();
    const n = Q2(e) === "dev", r = e[L3], a = await e.parseBody();
    if (Array.isArray(a)) {
      const [i, ...s] = a;
...
function Ze2(e) {
  return async (t) => {
    ...
    try {
      const h2 = Q2(t) === "static", m = Fe3(t), u = await e({ base: t.basePathname + "build/", stream: c, serverData: m, containerAttributes: { "q:render": h2 ? "static" : "", ...m.containerAttributes } }), g = { loaders: I2(t), action: t.sharedMap.get(H3), status: d !== 200 ? d : 200, href: le3(t.url, a) };
...
function it2(e, t, n, r, a, i, s, o) {
  ...
  const Se3 = async () => {
    ...
    if (C3(), typeof f2 == "number") {
      ...
      D4.write(typeof p == "string" ? $2.encode(p) : p), D4.close();
  ...
  try {
    ...
    if (n instanceof W3)
      ...
      if (console.error(n), !e.headersSent) {
        const r = Me2(n.status, n), a = n.status;
        e.html(a, r);
      }
      ...
      if (Q2(e) !== "dev")
        try {
          ...
          if (!r.locked) {
            const a = r.getWriter();
            await a.write($2.encode(se4(500, "Internal Server Error"))), await a.close();
          }
        } catch {
...
var Pt2 = St2({ render: We2, qwikCityPlan: Ce3, manifest: Pe2 });
...
// .wrangler/tmp/pages-KWvfC1/5ahm6ab3l1c.js
...
// .wrangler/tmp/bundle-m29WFy/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-m29WFy/middleware-loader.entry.ts
...
* found in the LICENSE file at https://github.com/BuilderIO/qwik/blob/main/LICENSE
*/
//# sourceMappingURL=5ahm6ab3l1c.js.map
