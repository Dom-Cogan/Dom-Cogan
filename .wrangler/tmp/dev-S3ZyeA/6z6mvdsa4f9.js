...
// .wrangler/tmp/bundle-BIxq5C/checked-fetch.js
...
// .wrangler/tmp/pages-0YimNn/bundledWorker-0.3412425725228345.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-6S7Fbs/checked-fetch.js"() {
    "use strict";
...
var vn = (t, e, n, s, o, r) => {
  ...
  if (typeof i == "string") {
    ...
    const w = (v2, _3, q4) => {
      ...
      if (C(_3) && (_3 = it(_3, q4 ? [1, y, _3, c.$element$, v2] : [2, c.$element$, _3, y, v2]), p = true), v2 === D)
        return void (h2 = _3);
      let R2;
    ...
    for (const v2 in f) {
      let _3 = false, q4;
      v2 in d ? (_3 = true, q4 = d[v2], q4 === M && (q4 = f[v2])) : q4 = f[v2], w(v2, q4, _3);
    }
    for (const v2 in d) {
      if (v2 in f)
        continue;
    ...
    if (b2 && (o |= 1), i in fr && (o |= 16), i in dr && (o |= 8), g && (u += ' class="' + Be(g) + '"'), E3.length > 0) {
      const v2 = pn(E3), _3 = !!(16 & o);
      for (const q4 of v2) {
        const R2 = _3 ? Ps(q4[0]) : q4[0];
        u += " " + R2 + '="' + Fn(q4[1], e.$static$.$containerState$, m) + '"', Ke(R2, e.$static$.$containerState$);
      }
    }
  ...
  if (t.$slotCtx$ ? (m.$parentCtx$ = t.$slotCtx$, m.$realParentCtx$ = t.$cmpCtx$) : m.$parentCtx$ = t.$cmpCtx$, l) {
    if ("q:renderFn" in a) {
      ...
      const w = I(wn(t, m, n), () => {
        ...
        const x2 = co(m), v2 = [], _3 = oo(E3);
        for (const q4 in _3) {
          const R2 = _3[q4], k3 = io(f, x2, m, q4, f.$containerState$), st2 = oe(t), kt = k3.$element$;
...
var Bi = async (t, e, n, s) => {
  ...
  const $3 = /* @__PURE__ */ new Map(), l = Array.from(o.$objSet$.keys()), a = /* @__PURE__ */ new Map(), f = (h2) => {
    ...
    if (ct(h2)) {
      ...
      if (v2)
        ...
        const _3 = ((q4) => {
          let R2 = $3.get(q4);
          return R2 === void 0 && (R2 = tc(q4), R2 || console.warn("Missing ID", q4), $3.set(q4, R2)), R2;
        })(h2);
        return _3 ? "#" + _3 + w : null;
      }
    }
  ...
  for (const h2 of t) {
    const w = h2.$element$, E3 = h2.$id$, x2 = h2.$refMap$, v2 = h2.$props$, _3 = h2.$contexts$, q4 = h2.$tasks$, R2 = h2.$componentQrl$, k3 = h2.$seq$, st2 = {}, kt = nt(w) && o.$elements$.includes(h2);
    if (x2.length > 0) {
      const U2 = wt(x2, d, " ");
      U2 && (S2[E3] = U2);
    } else if (c) {
...
var p$ = ({ track: t }) => {
  ...
  async function d() {
    ...
    if (g = new URL(y.dest, f.url), w = r.loadedRoute, h2 = r.response, w) {
      const [E3, x2, v2, _3] = w, q4 = v2, R2 = q4[q4.length - 1];
      f.prevUrl = p, f.url = g, f.params = { ...x2 }, a.untrackedValue = { type: S2, dest: g };
      const k3 = a$(h2, f, q4, u);
      n.headings = R2.headings, n.menu = _3, s.value = Qe(q4), o.links = k3.links, o.meta = k3.meta, o.styles = k3.styles, o.scripts = k3.scripts, o.title = k3.title, o.frontmatter = k3.frontmatter;
    }
  }
  return d();
};
...
init_checked_fetch();
init_modules_watch_stub();
var ge2 = ((t) => typeof __require2 < "u" ? __require2 : typeof Proxy < "u" ? new Proxy(t, { get: (e, n) => (typeof __require2 < "u" ? __require2 : e)[n] }) : t)(function(t) {
...
function Z2(t, e) {
  ...
  return { isServer: true, async importSymbol(i, a, o) {
    var _3;
    const c = N2(o), m = (_3 = globalThis.__qwik_reg_symbols) == null ? void 0 : _3.get(c);
    if (m)
      return m;
    let u = String(a);
    u.endsWith(".js") || (u += ".js");
...
function Ce2(t) {
  const e = { bundles: q(t).map((n) => n.split("/").pop()) };
...
function Ne2(t, e, n) {
  ...
  return s.prefetchEvent === "always" && Ie2(r, e, n), s.linkInsert === "html-append" && Se2(r, e, s), s.linkInsert === "js-append" ? Ee2(r, e, s, n) : s.workerFetchInsert === "always" && Te2(r, e, n), r.length > 0 ? v$(he, { children: r }) : null;
}
function Ie2(t, e, n) {
  const s = ze2(e);
  for (const r of s)
...
function Te2(t, e, n) {
  let s = `const u=${JSON.stringify(q(e))};`;
...
async function Ae2(t, e) {
  ...
  const m = ((B3 = e.streaming) == null ? void 0 : B3.inOrder) ?? { strategy: "auto", maximunInitialChunk: 5e4, maximunChunk: 3e4 }, u = e.containerTagName ?? "html", j4 = e.containerAttributes ?? {}, _3 = n, se4 = z(), ie4 = ee2(e), p = ne2(e.manifest);
  function E3() {
  ...
  const re4 = z(), O4 = [];
  let D3 = 0, A3 = 0;
  await g$(t, { stream: n, containerTagName: u, containerAttributes: j4, serverData: e.serverData, base: ie4, beforeContent: x2, beforeClose: async (l, f, P3, v2) => {
    var M2, W4, U2, $3, Y4;
    D3 = re4();
    const g = z();
    ...
    if (e.prefetchStrategy !== null) {
      const h2 = xe2(c, e, p);
      if (h2.length > 0) {
        const V4 = Ne2(e.prefetchStrategy, h2, (M2 = e.serverData) == null ? void 0 : M2.nonce);
        V4 && w.push(V4);
      }
    }
    const ae4 = JSON.stringify(c.state, void 0, void 0);
    w.push(v$("script", { type: "qwik/json", dangerouslySetInnerHTML: Be2(ae4), nonce: (W4 = e.serverData) == null ? void 0 : W4.nonce })), c.funcs.length > 0 && w.push(v$("script", { "q:func": "qwik/json", dangerouslySetInnerHTML: Pe2(c.funcs), nonce: (U2 = e.serverData) == null ? void 0 : U2.nonce }));
    const ce4 = !c || c.mode !== "static", R2 = k3 === "always" || k3 === "auto" && ce4;
    if (R2) {
      const h2 = G2({ debug: e.debug });
      w.push(v$("script", { id: "qwikloader", dangerouslySetInnerHTML: h2, nonce: ($3 = e.serverData) == null ? void 0 : $3.nonce }));
    }
    const K4 = Array.from(f.$events$, (h2) => JSON.stringify(h2));
    if (K4.length > 0) {
      const h2 = (R2 ? "window.qwikevents" : "(window.qwikevents||=[])") + `.push(${K4.join(", ")})`;
      w.push(v$("script", { dangerouslySetInnerHTML: h2, nonce: (Y4 = e.serverData) == null ? void 0 : Y4.nonce }));
    }
    return Le2(O4, l), A3 = g(), v$(he, { children: w });
  }, manifestHash: (p == null ? void 0 : p.manifest.manifestHash) || "dev" }), u !== "html" && n.write("<!--/cq-->"), E3();
  const oe4 = c.resources.some((l) => l._cache !== 1 / 0);
  return { prefetchResources: void 0, snapshotResult: c, flushes: i, manifest: p == null ? void 0 : p.manifest, size: r, isStatic: !oe4, timing: { render: D3, snapshot: A3, firstFlush: a }, _symbols: O4 };
}
function ne2(t) {
  if (t) {
    if ("mapper" in t)
...
var Me2 = Un(Lt(Ke2, "s_0vphQYqOdZI"));
var We2 = () => ft(R$, { children: [xt("head", null, null, [xt("meta", null, { charSet: "utf-8" }, null, 3, null), xt("link", null, { rel: "manifest", href: "/manifest.json" }, null, 3, null), ft(Me2, null, 3, "vp_0")], 1, null), xt("body", null, { lang: "en" }, [ft(T$, null, 3, "vp_1"), ft(A$, null, 3, "vp_2")], 1, null)] }, 1, "vp_3");
var Ue2 = Un(Lt(We2, "s_tntnak2DhJ8"));
function Je2(t) {
  return Ae2(ft(Ue2, null, 3, "Qb_0"), { manifest: Re2, ...t, containerAttributes: { lang: "en-us", ...t.containerAttributes } });
}
init_checked_fetch();
init_modules_watch_stub();
init_checked_fetch();
...
var L2 = ["flex", "w-full", "max-h-[100vh]", "justify-center", "overflow-hidden", "scrollbar-hidden"];
var N3 = ["p-4", "flex", "mt-4", "w-full", "flex-col", "h-screen", "rounded-md", "items-center", "shadow-border", "scrollbar-hidden"];
var j2 = ["m-8", "mx-12", "max-w-2xl", "overflow-scroll", "scrollbar-hidden", "overflow-x-hidden"];
var Q2 = ["w-screen", "h-screen", "flex", "items-center", "flex-col", "justify-center"];
var H2 = ["flex", "h-5/6", "font-bold", "text-6xl", "text-center", "justify-center", "items-center"];
...
var z2 = ["m-3", "flex", "rounded", "border-4", "items-center", "border-LIGHT-txtPrimary", "justify-center", "hover:bg-LIGHT-bgSecondary"];
var F2 = ["m-4", "h-1", "rounded", "bg-LIGHT-txtSecondary"];
var W2 = ["m-4", "p-4", "text-lg", "shadow-border"];
var A2 = (e) => {
  const l = k$();
  return xt("div", null, { class: z2, onClick$: x$("s_lNnfZJK390A", [l, e]) }, y$((o) => o.icon, [e], "p0.icon"), 3, "tW_0");
};
var _ = Un(Lt(A2, "s_NCzEU0RO00k"));
...
var U = Un(Lt(E, "s_Te3w2ykiWWU"));
var q2 = () => {
  const l = ["w-1/5", "flex", "flex-col", "justify-center", Je(true).value ? "max-w-[70px]" : "w-3/5"];
  return xt("div", { class: l }, null, xt("div", null, null, [ft(_, { willNav: true, get icon() {
    return v$(R, {});
  }, [M]: { willNav: M, icon: M } }, 3, "Tj_0"), ft(_, { willNav: true, get icon() {
    return v$(U, {});
  }, link: "blog", [M]: { willNav: M, icon: M, link: M } }, 3, "Tj_1")], 1, null), 1, "Tj_2");
};
var J2 = Un(Lt(q2, "s_PX8yQoK5ags"));
var X2 = async ({ cacheControl: e }) => {
  e({ staleWhileRevalidate: 604800, maxAge: 5 });
};
var $ = () => xt("div", null, { class: L2 }, [xt("div", { class: [["w-1/5", "flex", "justify-end", "items-center", "sm:max-w-[70px]"], ["sm:hidden md:flex"]] }, null, null, 3, null), xt("div", { class: ["flex", "w-4/5", "h-full", "m-4"] }, null, xt("div", null, { class: N3 }, ft(xe, null, 3, "yB_0"), 1, null), 1, null), ft(J2, null, 3, "yB_1")], 1, "yB_2");
var D2 = Un(Lt($, "s_VKFlAWJuVm8"));
var Z3 = Object.freeze(Object.defineProperty({ __proto__: null, default: D2, onGet: X2 }, Symbol.toStringTag, { value: "Module" }));
...
var te3 = (e) => xt("div", null, { class: H2 }, ["Loading ", y$((l) => l.message, [e], "p0.message"), "..."], 3, "qE_0");
var S = Un(Lt(te3, "s_C3I542fyxnM"));
var le2 = () => {
  si();
  const e = le({ blogPosts: [] });
  return w$(x$("s_9bX79PSaULI", [e])), xt("div", null, { class: j2 }, e.blogPosts.length > 0 ? e.blogPosts.map((l) => ft(ee3, { get title() {
    return l.title;
  }, get id() {
    return l.id;
  }, get description() {
...
var re2 = () => {
  ...
  return w$(x$("s_79BRs3cztfk", [o, l])), xt("div", null, { class: j2 }, o.blogPost ? ft(he, { children: [ft(ce2, { get text() {
    return o.blogPost.title;
  }, [M]: { text: y$((s) => s.blogPost.title, [o], "p0.blogPost.title") } }, 3, "4y_0"), o.blogPost.sections.map((s) => xt("div", null, { class: W2 }, s.pageSections.map((u) => xt("div", { class: [u.type === "header" ? V2 : u.type === "break" ? F2 : ""] }, null, ci(u, "content"), 1, u.type)), 1, s.id))] }, 1, "4y_1") : ft(S, { message: "blog", [M]: { message: M } }, 3, "4y_2"), 1, "4y_3");
};
...
var xe3 = () => xt("div", null, { class: Q2 }, [xt("h1", null, { class: ["p-4", "text-center", "text-6xl", "font-extrabold"] }, "Hello & Welcome", 3, null), xt("p", null, { class: O2 }, "First off, thank you for visiting. My name is Dom Cogan, and this is my portfolio website. I did not attend college. In my spare time, I love learning new skills, I've taught myself Flutter, Qwik, Next.js, and CSS.", 3, null), xt("div", null, { class: C2 }, ft(ge3, { text: "Blog", link: "blog", [M]: { text: M, link: M } }, 3, "Vi_0"), 1, null)], 1, "Vi_1");
var me2 = Un(Lt(xe3, "s_uJ8rhQ0Ae0E"));
var be3 = { title: "Dom Cogan", meta: [{ name: "Landing", content: "This is the landing page for the portfolio of Dom Cogan. He is a self taught pomputer programer. I taught myself Qwik, styleX, Flutter, Tailwind, Next.js and CSS" }] };
var C2 = ["flex", "justify-center", "items-center", "select-none"];
var fe2 = Object.freeze(Object.defineProperty({ __proto__: null, _auto_row: C2, default: me2, head: be3 }, Symbol.toStringTag, { value: "Module" }));
var _e3 = [];
var h = () => Z3;
var he2 = [["blog/", [h, () => se2], "/blog/", ["q-8hz7zNIb.js", "q-ppyTdCyI.js"]], ["blog/[id]/", [h, () => ue2], "/blog/[id]/", ["q-8hz7zNIb.js", "q-CsEn0X9s.js"]], ["[...home]", [() => fe2], "/[...home]", ["q-BjfyW76R.js"]]];
var ve3 = [];
var ye2 = true;
var pe2 = "/";
var we2 = true;
var Se3 = { routes: he2, serverPlugins: _e3, menus: ve3, trailingSlash: ye2, basePathname: pe2, cacheModules: we2 };
...
var Qe3 = class {
  constructor(e) {
    this[oe3] = {}, this[ce3] = {}, this[k2] = He2(e), this[_2] = { ...this[k2] };
  }
  get(e, t = true) {
...
function Ze2(e) {
  return async (t) => {
    ...
    try {
      const h2 = Q3(t) === "static", m = Fe3(t), u = await e({ base: t.basePathname + "build/", stream: c, serverData: m, containerAttributes: { "q:render": h2 ? "static" : "", ...m.containerAttributes } }), g = { loaders: I3(t), action: t.sharedMap.get(H3), status: d !== 200 ? d : 200, href: le3(t.url, a) };
...
function it2(e, t, n, r, a, i, s, o) {
  ...
  g.pathname.endsWith(x) && (g.pathname = g.pathname.slice(0, -ge4), a && !g.pathname.endsWith("/") && (g.pathname += "/"), h2.set(P2, true)), h2.set("@manifest", r);
  ...
  const Se4 = async () => {
    ...
    return U2();
  }, U2 = () => (w = E2, new B2()), z3 = {}, R2 = { [fe3]: z3, [ue3]: e.mode, [he3]: a, [de3]: t, [L3]: s, cookie: m, headers: u, env: d, method: l.method, signal: l.signal, params: (t == null ? void 0 : t[1]) ?? {}, pathname: g.pathname, platform: c, query: g.searchParams, request: l, url: g, basePathname: i, sharedMap: h2, get headersSent() {
    return y !== null;
  }, get exited() {
    return w >= E2;
  }, get clientConn() {
    ...
    if (f.__brand === "server_loader" && !(p in z3))
      throw new Error("You can not get the returned data of a loader that has not been executed for this request.");
    return z3[p];
  }, status: (f) => typeof f == "number" ? (C3(), S2 = f, f) : S2, locale: (f) => (typeof f == "string" && (T2 = f), T2 || ""), error: (f, p) => (S2 = f, u.delete("Cache-Control"), new ie3(f, p)), redirect: (f, p) => {
    if (C3(), S2 = f, p) {
  ...
  async function n(r, a, i) {
    try {
      ...
      const h2 = await wt2({ mode: "server", locale: void 0, url: s, request: r, env: { get(u) {
        ...
        const { readable: A3, writable: T2 } = new TransformStream(), S2 = new Response(A3, { status: u, headers: Ue3(g, w) });
        return y(S2), T2;
...
var Pt2 = St2({ render: Je2, qwikCityPlan: Se3, manifest: Re2 });
...
// .wrangler/tmp/pages-0YimNn/6z6mvdsa4f9.js
...
// .wrangler/tmp/bundle-BIxq5C/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-BIxq5C/middleware-loader.entry.ts
...
* found in the LICENSE file at https://github.com/BuilderIO/qwik/blob/main/LICENSE
*/
//# sourceMappingURL=6z6mvdsa4f9.js.map
