...
// .wrangler/tmp/bundle-0pAHWy/checked-fetch.js
...
// .wrangler/tmp/pages-mXYl3h/bundledWorker-0.22818565488991327.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-jgcJJW/checked-fetch.js"() {
    "use strict";
...
var ks = (t, e, n, s, o, r, i, c) => {
  ...
  return I(y, () => {
    ...
    let u;
    if (f2) {
      const S3 = (p = o.$projectedChildren$) == null ? void 0 : p[d];
      if (S3) {
        const [g, h2] = o.$projectedCtxs$, w = oe(g);
        w.$slotCtx$ = e, o.$projectedChildren$[d] = void 0, u = K(S3, w, h2, r, i);
      }
    }
...
var lr = (t, e, n, s, o, r, i) => (ur(t, s, o.props.props), I(fe(t, s), (c) => {
  ...
  return s.$id$ = m, e.$static$.$contexts$.push(s), ks(b, s, d, l, f2, n, r, (u) => {
    ...
    if (p) {
      ...
      }), [h2, w] = f2.$projectedCtxs$, E3 = oe(h2);
...
var vn = (t, e, n, s, o, r) => {
  ...
  if (typeof i == "string") {
    ...
    let u = "<" + i, p = false, S3 = false, g = "", h2 = null;
    const w = (v3, _2, q3) => {
      if (v3 === "ref")
    ...
    if (a != null && (u += ' q:key="' + Be(a) + '"'), S3 || p || E3.length > 0) {
      if (S3 || p || yr(E3)) {
        const v3 = Jt(e);
        u += ' q:id="' + v3 + '"', m.$id$ = v3;
      }
  ...
  for (; c = l.nextNode(); ) {
    ...
    if ($3 === 0) {
      if (u.startsWith("qv ")) {
        ...
        const p = u.slice(2), S3 = j(p), g = Ir(c);
...
var Br = (t, e, n, s) => {
  ...
  const i = t.$qrl$.getFn(o, () => {
    r.$clearSub$(t);
  }), c = [], $3 = t.$state$, l = $e($3), a = { track: (p, S3) => {
    if (J(p)) {
      const h2 = Y();
      return h2.$renderCtx$ = n, h2.$subscriber$ = [0, t], W(h2, p);
    }
    const g = F(p);
    return g ? g.$addSub$([0, t], S3) : $n(Te(26), p), S3 ? p[S3] : C(p) ? p.value : p;
  }, cleanup(p) {
    c.push(p);
  }, cache(p) {
    let S3 = 0;
    S3 = p === "immutable" ? 1 / 0 : p, $3._cache = S3;
  }, previous: l._resolved };
  let f2, d, m = false;
  const y = (p, S3) => !m && (m = true, p ? (m = true, $3.loading = false, $3._state = "resolved", $3._resolved = S3, $3._error = void 0, f2(S3)) : (m = true, $3.loading = false, $3._state = "rejected", $3._error = S3, d(S3)), true);
  W(o, () => {
    $3._state = "pending", $3.loading = !V(), $3.value = new Promise((p, S3) => {
      f2 = p, d = S3;
    });
  }), t.$destroy$ = Qe(() => {
...
var ai = (t, e, n, s, o) => {
  let r = 0, i = 0, c = n.length - 1, $3 = n[0], l = n[c], a = s.length - 1, f2 = s[0], d = s[a], m, y, b;
  const u = [], p = t.$static$;
  for (; r <= c && i <= a; )
    if ($3 == null)
      $3 = n[++r];
      ...
      $3.$elm$, l.$elm$, u.push(Rt(t, l, f2, o)), Pt(p, e, l.$elm$, $3.$elm$), l = n[--c], f2 = s[++i];
    else {
      if (m === void 0 && (m = Ei(n, r, c)), y = m[f2.$key$], y === void 0) {
        ...
        u.push(Rt(t, b, f2, o)), n[y] = void 0, b.$elm$, Pt(p, e, b.$elm$, $3.$elm$);
      f2 = s[++i];
    }
      ...
      for (const y in l) {
        ...
        if (y !== "ref")
          if (dn(y)) {
            ...
            C(b) && (b = it(b, [1, $3.$element$, b, o, y])), y === "class" ? b = yn(b, $3) : y === "style" && (b = Pe(b)), m[y] !== b && (m[y] = b, Pn(i, o, y, b, d));
        else
          b !== void 0 && Mn(b, o);
      }
    }
...
var bt = (t, e, n, s) => {
  ...
  if (o === "#signal") {
    ...
    }
    {
      ...
      return S3.data = e.$text$ = Gt(p), it(u, 4 & n ? [3, S3, u, S3] : [4, i.$element$, u, S3]), e.$elm$ = S3;
    }
  }
  let c, $3 = !!(n & B);
  $3 || o !== "svg" || (n |= B, $3 = true);
  ...
  if (t.$slotCtx$ ? (m.$parentCtx$ = t.$slotCtx$, m.$realParentCtx$ = t.$cmpCtx$) : m.$parentCtx$ = t.$cmpCtx$, l) {
    if ("q:renderFn" in a) {
      const u = a["q:renderFn"], p = Ae(), S3 = d.$subsManager$.$createManager$(), g = new Proxy(p, new vs(d, S3)), h2 = a.props;
    ...
    if (e.$immutableProps$) {
      const u = a !== O ? Object.fromEntries(Object.entries(e.$immutableProps$).map(([p, S3]) => [p, S3 === M ? a[p] : S3])) : e.$immutableProps$;
      ss(f2, m, i, u, $3, true);
    }
    if (a !== O) {
      m.$vdom$ = e;
...
var Bi = async (t, e, n, s) => {
  ...
  for (; (i = o.$promises$).length > 0; )
    o.$promises$ = [], await Promise.all(i);
  const $3 = /* @__PURE__ */ new Map(), l = Array.from(o.$objSet$.keys()), a = /* @__PURE__ */ new Map(), f2 = (h2) => {
    let w = "";
    if (L(h2)) {
      const v3 = mo(h2);
      if (!v3)
  ...
  for (const h2 of l) {
    ...
    if (w == null)
      break;
    b.push(w.map((E3) => typeof E3 == "number" ? `_${E3}` : Oc(E3, f2)).filter(ms));
  }
  b.length, m.size;
  const u = yo(l, d, f2, o, e), p = {}, S3 = {};
  for (const h2 of t) {
    const w = h2.$element$, E3 = h2.$id$, x2 = h2.$refMap$, v3 = h2.$props$, _2 = h2.$contexts$, q3 = h2.$tasks$, R2 = h2.$componentQrl$, k3 = h2.$seq$, st2 = {}, kt = nt(w) && o.$elements$.includes(h2);
    if (x2.length > 0) {
      const U2 = wt(x2, d, " ");
      U2 && (S3[E3] = U2);
    } else if (c) {
  ...
  return { state: { refs: S3, ctx: p, objs: u, subs: b }, objs: l, funcs: o.$inlinedFunctions$, resources: o.$resources$, qrls: o.$qrls$, mode: c ? "render" : "listeners" };
};
var wt = (t, e, n) => {
  let s = "";
  for (const o of t) {
...
var We = (t, e, n, s, o, r, i) => {
  ...
  const $3 = async function(...u) {
      ...
      return n = s().then((p) => $3.resolved = n = p[e]);
    {
      ...
      return n = I(p, (S3) => $3.resolved = n = S3);
    }
  }, f2 = (u) => n !== null ? n : a(u);
  function d(u, p) {
    return (...S3) => {
  ...
  return Object.assign($3, { getSymbol: () => y, getHash: () => b, getCaptured: () => r, resolve: a, $resolveLazy$: f2, $setContainer$: l, $chunk$: t, $symbol$: e, $refSymbol$: i, $hash$: b, getFn: d, $capture$: o, $captureRef$: r, dev: null, resolved: e == "<sync>" ? n : void 0 }), $3;
};
var qo = (t) => {
    ...
    if (b(), e[i] = () => {
      ...
      if (!e[s]) {
        if (e[a] = false, clearTimeout(e[f2]), n !== location.pathname + location.search) {
          ...
          if (S3) {
            const g = S3.closest("[q\\:container]"), h2 = S3.cloneNode();
      ...
      e[o] = true;
      const u = history.pushState, p = history.replaceState, S3 = (g) => (g === null || typeof g > "u" ? g = {} : (g == null ? void 0 : g.constructor) !== Object && (g = { _data: g }), g._qCityScroll = g._qCityScroll || y(), g);
      history.pushState = (g, h2, w) => (g = S3(g), u.call(history, g, h2, w)), history.replaceState = (g, h2, w) => (g = S3(g), p.call(history, g, h2, w));
    }
    e[c] = (u) => {
      ...
      if (p && !p.hasAttribute("preventdefault:click")) {
        const S3 = p.getAttribute("href"), g = new URL(location.href), h2 = new URL(S3, g), w = h2.origin === g.origin, E3 = h2.pathname + h2.search === g.pathname + g.search;
        if (w && E3)
...
var p$ = ({ track: t }) => {
  ...
  async function d() {
    const [y, b] = t(() => [a.value, e.value]), u = Zr(""), p = f2.url, S3 = b ? "form" : y.type;
    y.replaceState;
    let g, h2, w = null;
    if (g = new URL(y.dest, f2.url), w = r.loadedRoute, h2 = r.response, w) {
      const [E3, x2, v3, _2] = w, q3 = v3, R2 = q3[q3.length - 1];
      f2.prevUrl = p, f2.url = g, f2.params = { ...x2 }, a.untrackedValue = { type: S3, dest: g };
...
function Z2(t, e) {
  ...
  return { isServer: true, async importSymbol(i, a, o) {
    var _2;
    const c = z(o), m = (_2 = globalThis.__qwik_reg_symbols) == null ? void 0 : _2.get(c);
    if (m)
      return m;
    let u = String(a);
    u.endsWith(".js") || (u += ".js");
...
function Ne2(t) {
  ...
  const s = (o, c) => {
    if (Array.isArray(o))
      for (const m of o) {
        const u = e.get(m.url) || 0;
        e.set(m.url, u + 1), n++, c.has(m.url) || (c.add(m.url), s(m.imports, c));
      }
  }, r = /* @__PURE__ */ new Set();
  for (const o of t)
...
function ze2(t, e, n) {
  const s = Te2(t == null ? void 0 : t.implementation), r = [];
  return s.prefetchEvent === "always" && Se2(r, e, n), s.linkInsert === "html-append" && Oe2(r, e, s), s.linkInsert === "js-append" ? De2(r, e, s, n) : s.workerFetchInsert === "always" && Ie2(r, e, n), r.length > 0 ? v$(he, { children: r }) : null;
}
function Se2(t, e, n) {
  const s = Ne2(e);
  for (const r of s)
...
async function Ee2(t, e) {
  ...
  const re4 = N2(), F4 = [];
  let B4 = 0, E3 = 0;
  await g$(t, { stream: n, containerTagName: u, containerAttributes: q3, serverData: e.serverData, base: ie4, beforeContent: x2, beforeClose: async (l, f2, A3, v3) => {
    var V4, U2, M2, W4, G3;
    B4 = re4();
    const y = N2();
    c = await Bi(l, f2, void 0, v3);
    const g = [];
    if (e.prefetchStrategy !== null) {
      const h2 = xe2(c, e, p);
      if (h2.length > 0) {
        const H4 = ze2(e.prefetchStrategy, h2, (V4 = e.serverData) == null ? void 0 : V4.nonce);
        H4 && g.push(H4);
      }
    }
    const ae4 = JSON.stringify(c.state, void 0, void 0);
    g.push(v$("script", { type: "qwik/json", dangerouslySetInnerHTML: Qe2(ae4), nonce: (U2 = e.serverData) == null ? void 0 : U2.nonce })), c.funcs.length > 0 && g.push(v$("script", { "q:func": "qwik/json", dangerouslySetInnerHTML: Ae2(c.funcs), nonce: (M2 = e.serverData) == null ? void 0 : M2.nonce }));
    const ce4 = !c || c.mode !== "static", L4 = k3 === "always" || k3 === "auto" && ce4;
    if (L4) {
      const h2 = J2({ debug: e.debug });
      g.push(v$("script", { id: "qwikloader", dangerouslySetInnerHTML: h2, nonce: (W4 = e.serverData) == null ? void 0 : W4.nonce }));
    }
    const K4 = Array.from(f2.$events$, (h2) => JSON.stringify(h2));
    if (K4.length > 0) {
      const h2 = (L4 ? "window.qwikevents" : "(window.qwikevents||=[])") + `.push(${K4.join(", ")})`;
      g.push(v$("script", { dangerouslySetInnerHTML: h2, nonce: (G3 = e.serverData) == null ? void 0 : G3.nonce }));
    }
    return Pe2(F4, l), E3 = y(), v$(he, { children: g });
  }, manifestHash: (p == null ? void 0 : p.manifest.manifestHash) || "dev" }), u !== "html" && n.write("<!--/cq-->"), D3();
  const oe4 = c.resources.some((l) => l._cache !== 1 / 0);
  return { prefetchResources: void 0, snapshotResult: c, flushes: i, manifest: p == null ? void 0 : p.manifest, size: r, isStatic: !oe4, timing: { render: B4, snapshot: E3, firstFlush: a }, _symbols: F4 };
}
function ne2(t) {
  if (t) {
    if ("mapper" in t)
...
var Qe2 = (t) => t.replace(/<(\/?script)/gi, "\\x3C$1");
function Pe2(t, e) {
  var n;
  for (const s of e) {
...
var Le2 = { manifestHash: "us0wr7", symbols: { s_02wMImzEAbk: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "QwikCityProvider_component_useTask", canonicalFilename: "s_02wmimzeabk", hash: "02wMImzEAbk", ctxKind: "function", ctxName: "useTask$", captures: true, parent: "s_TxCFOy819ag", loc: [26977, 36148] }, s_79BRs3cztfk: { origin: "routes/blog/[id]/index.tsx", displayName: "_id__component_useVisibleTask", canonicalFilename: "s_79brs3cztfk", hash: "79BRs3cztfk", ctxKind: "function", ctxName: "useVisibleTask$", captures: true, parent: "s_wCieFdpQfC4", loc: [726, 1252] }, s_9bX79PSaULI: { origin: "routes/blog/index.tsx", displayName: "blog_component_useVisibleTask", canonicalFilename: "s_9bx79psauli", hash: "9bX79PSaULI", ctxKind: "function", ctxName: "useVisibleTask$", captures: true, parent: "s_GBQBGBjVVwU", loc: [543, 870] }, s_0jIn91G00l8: { origin: "components/buttons/primaryBtn.tsx", displayName: "primaryBtn_component", canonicalFilename: "s_0jin91g00l8", hash: "0jIn91G00l8", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [201, 677] }, s_0vphQYqOdZI: { origin: "components/router-head/router-head.tsx", displayName: "RouterHead_component", canonicalFilename: "s_0vphqyqodzi", hash: "0vphQYqOdZI", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [243, 854] }, s_8gdLBszqbaM: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "Link_component", canonicalFilename: "s_8gdlbszqbam", hash: "8gdLBszqbaM", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [38132, 40792] }, s_BYJFogMmj5g: { origin: "components/page/sections/title.tsx", displayName: "title_component", canonicalFilename: "s_byjfogmmj5g", hash: "BYJFogMmj5g", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [252, 652] }, s_C3I542fyxnM: { origin: "components/loading.tsx", displayName: "loading_component", canonicalFilename: "s_c3i542fyxnm", hash: "C3I542fyxnM", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [172, 257] }, s_Ckljc1FxMOo: { origin: "components/page/overview.tsx", displayName: "overview_component", canonicalFilename: "s_ckljc1fxmoo", hash: "Ckljc1FxMOo", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [292, 1170] }, s_GBQBGBjVVwU: { origin: "routes/blog/index.tsx", displayName: "blog_component", canonicalFilename: "s_gbqbgbjvvwu", hash: "GBQBGBjVVwU", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [428, 1260] }, s_GDRT3QzP3eQ: { origin: "components/page/sections/break.tsx", displayName: "break_component", canonicalFilename: "s_gdrt3qzp3eq", hash: "GDRT3QzP3eQ", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [165, 288] }, s_NCzEU0RO00k: { origin: "components/buttons/navButton.tsx", displayName: "navButton_component", canonicalFilename: "s_nczeu0ro00k", hash: "NCzEU0RO00k", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [259, 648] }, s_Nk9PlpjQm9Y: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "GetForm_component", canonicalFilename: "s_nk9plpjqm9y", hash: "Nk9PlpjQm9Y", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [51180, 52717] }, s_PX8yQoK5ags: { origin: "components/columns/sidemenu.tsx", displayName: "sidemenu_component", canonicalFilename: "s_px8yqok5ags", hash: "PX8yQoK5ags", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [198, 713] }, s_Te3w2ykiWWU: { origin: "icons/blog.tsx", displayName: "blog_component", canonicalFilename: "s_te3w2ykiwwu", hash: "Te3w2ykiWWU", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [75, 659] }, s_TxCFOy819ag: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "QwikCityProvider_component", canonicalFilename: "s_txcfoy819ag", hash: "TxCFOy819ag", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [23707, 36435] }, s_VKFlAWJuVm8: { origin: "routes/layout.tsx", displayName: "layout_component", canonicalFilename: "s_vkflawjuvm8", hash: "VKFlAWJuVm8", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [680, 1188] }, s_WmYC5H00wtI: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "QwikCityMockProvider_component", canonicalFilename: "s_wmyc5h00wti", hash: "WmYC5H00wtI", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [36719, 38013] }, s_abp1tubNbSA: { origin: "icons/home.tsx", displayName: "home_component", canonicalFilename: "s_abp1tubnbsa", hash: "abp1tubNbSA", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [75, 611] }, s_ati7nisKH2g: { origin: "routes/[...home]/layout.tsx", displayName: "layout_component", canonicalFilename: "s_ati7niskh2g", hash: "ati7nisKH2g", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [589, 617] }, s_drAReQyZk0U: { origin: "icons/close.tsx", displayName: "close_component", canonicalFilename: "s_drareqyzk0u", hash: "drAReQyZk0U", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [75, 397] }, s_e0ssiDXoeAM: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "RouterOutlet_component", canonicalFilename: "s_e0ssidxoeam", hash: "e0ssiDXoeAM", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [7817, 8531] }, s_hEKvrfdTKXg: { origin: "icons/auth.tsx", displayName: "auth_component", canonicalFilename: "s_hekvrfdtkxg", hash: "hEKvrfdTKXg", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [75, 576] }, s_i6dEatiCz8c: { origin: "icons/icon.tsx", displayName: "icon_component", canonicalFilename: "s_i6deaticz8c", hash: "i6dEatiCz8c", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [75, 1321] }, s_rkuYV2qXCqk: { origin: "icons/website.tsx", displayName: "website_component", canonicalFilename: "s_rkuyv2qxcqk", hash: "rkuYV2qXCqk", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [75, 852] }, s_tntnak2DhJ8: { origin: "root.tsx", displayName: "root_component", canonicalFilename: "s_tntnak2dhj8", hash: "tntnak2DhJ8", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [267, 792] }, s_uJ8rhQ0Ae0E: { origin: "routes/[...home]/index!.tsx", displayName: "index__component", canonicalFilename: "s_uj8rhq0ae0e", hash: "uJ8rhQ0Ae0E", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [236, 779] }, s_wCieFdpQfC4: { origin: "routes/blog/[id]/index.tsx", displayName: "_id__component", canonicalFilename: "s_wciefdpqfc4", hash: "wCieFdpQfC4", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [544, 2085] }, s_yg7MY3J7tGU: { origin: "components/page/sections/paragraph.tsx", displayName: "paragraph_component", canonicalFilename: "s_yg7my3j7tgu", hash: "yg7MY3J7tGU", ctxKind: "function", ctxName: "component$", captures: false, parent: null, loc: [284, 548] }, s_RPDJAz33WLA: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "QwikCityProvider_component_useStyles", canonicalFilename: "s_rpdjaz33wla", hash: "RPDJAz33WLA", ctxKind: "function", ctxName: "useStyles$", captures: false, parent: "s_TxCFOy819ag", loc: [23762, 23796] }, s_A5bZC7WO00A: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "routeActionQrl_action_submit", canonicalFilename: "s_a5bzc7wo00a", hash: "A5bZC7WO00A", ctxKind: "function", ctxName: "submit", captures: true, parent: null, loc: [41838, 43472] }, s_DyVc0YBIqQU: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "spa_init", canonicalFilename: "s_dyvc0ybiqqu", hash: "DyVc0YBIqQU", ctxKind: "function", ctxName: "spaInit", captures: false, parent: null, loc: [1355, 6830] }, s_wOIPfiQ04l4: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "serverQrl_stuff", canonicalFilename: "s_woipfiq04l4", hash: "wOIPfiQ04l4", ctxKind: "function", ctxName: "stuff", captures: true, parent: null, loc: [46780, 48976] }, s_BUbtvTyvVRE: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "QwikCityMockProvider_component_goto", canonicalFilename: "s_bubtvtyvvre", hash: "BUbtvTyvVRE", ctxKind: "function", ctxName: "goto", captures: false, parent: "s_WmYC5H00wtI", loc: [37134, 37212] }, s_Osdg8FnYTw4: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "Link_component_handlePrefetch", canonicalFilename: "s_osdg8fnytw4", hash: "Osdg8FnYTw4", ctxKind: "function", ctxName: "handlePrefetch", captures: false, parent: "s_8gdLBszqbaM", loc: [38832, 39163] }, s_fX0bDjeJa0E: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "QwikCityProvider_component_goto", canonicalFilename: "s_fx0bdjeja0e", hash: "fX0bDjeJa0E", ctxKind: "function", ctxName: "goto", captures: true, parent: "s_TxCFOy819ag", loc: [25046, 26365] }, s_kxX7fiVjwOg: { origin: "components/page/overview.tsx", displayName: "overview_component_div_onClick", canonicalFilename: "s_kxx7fivjwog", hash: "kxX7fiVjwOg", ctxKind: "eventHandler", ctxName: "onClick$", captures: true, parent: "s_Ckljc1FxMOo", loc: [942, 972] }, s_lNnfZJK390A: { origin: "components/buttons/navButton.tsx", displayName: "navButton_component_div_onClick", canonicalFilename: "s_lnnfzjk390a", hash: "lNnfZJK390A", ctxKind: "eventHandler", ctxName: "onClick$", captures: true, parent: "s_NCzEU0RO00k", loc: [398, 604] }, s_p9MSze0ojs4: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "GetForm_component_form_onSubmit", canonicalFilename: "s_p9msze0ojs4", hash: "p9MSze0ojs4", ctxKind: "function", ctxName: "_jsxS", captures: true, parent: "s_Nk9PlpjQm9Y", loc: [51668, 52365] }, s_pIf0khHUxfY: { origin: "../node_modules/@builder.io/qwik-city/index.qwik.mjs", displayName: "Link_component_handleClick", canonicalFilename: "s_pif0khhuxfy", hash: "pIf0khHUxfY", ctxKind: "function", ctxName: "handleClick", captures: true, parent: "s_8gdLBszqbaM", loc: [39590, 40110] }, s_zKGG5xGsigs: { origin: "components/buttons/primaryBtn.tsx", displayName: "primaryBtn_component_div_onClick", canonicalFilename: "s_zkgg5xgsigs", hash: "zKGG5xGsigs", ctxKind: "eventHandler", ctxName: "onClick$", captures: true, parent: "s_0jIn91G00l8", loc: [528, 633] } }, mapping: { s_02wMImzEAbk: "q-gPfqXXgU.js", s_79BRs3cztfk: "q-DFwGbhrM.js", s_9bX79PSaULI: "q-DiOoKElR.js", s_0jIn91G00l8: "q-Qv9c0kVt.js", s_0vphQYqOdZI: "q-rTUtui2W.js", s_8gdLBszqbaM: "q-k5DSPVCD.js", s_BYJFogMmj5g: "q-Dbb0mmIF.js", s_C3I542fyxnM: "q-MpnuTtA2.js", s_Ckljc1FxMOo: "q-BYF81Q4t.js", s_GBQBGBjVVwU: "q-DiOoKElR.js", s_GDRT3QzP3eQ: "q-C7JRSoZ_.js", s_NCzEU0RO00k: "q-BJ8p8H2g.js", s_Nk9PlpjQm9Y: "q-W-DP7Nje.js", s_PX8yQoK5ags: "q-tHpHQCTg.js", s_Te3w2ykiWWU: "q-DiOoKElR.js", s_TxCFOy819ag: "q-gPfqXXgU.js", s_VKFlAWJuVm8: "q-C-OXjSkJ.js", s_WmYC5H00wtI: "q-CciOo66m.js", s_abp1tubNbSA: "q-C0q0_ZTZ.js", s_ati7nisKH2g: "q-C-OXjSkJ.js", s_drAReQyZk0U: "q-BeBV7ZS2.js", s_e0ssiDXoeAM: "q-CmuGpiU_.js", s_hEKvrfdTKXg: "q-NQ9uuYVL.js", s_i6dEatiCz8c: "q-8YGB9J3i.js", s_rkuYV2qXCqk: "q-CJywxT-1.js", s_tntnak2DhJ8: "q-BupgBN2_.js", s_uJ8rhQ0Ae0E: "q-DSWH9Y8W.js", s_wCieFdpQfC4: "q-DFwGbhrM.js", s_yg7MY3J7tGU: "q-BLXmGQRh.js", s_RPDJAz33WLA: "q-gPfqXXgU.js", s_A5bZC7WO00A: "q-Szi5y3oT.js", s_DyVc0YBIqQU: "q-D3WBTSLL.js", s_wOIPfiQ04l4: "q-Cbdc-vfP.js", s_BUbtvTyvVRE: "q-CciOo66m.js", s_Osdg8FnYTw4: "q-k5DSPVCD.js", s_fX0bDjeJa0E: "q-gPfqXXgU.js", s_kxX7fiVjwOg: "q-BYF81Q4t.js", s_lNnfZJK390A: "q-BJ8p8H2g.js", s_p9MSze0ojs4: "q-W-DP7Nje.js", s_pIf0khHUxfY: "q-k5DSPVCD.js", s_zKGG5xGsigs: "q-Qv9c0kVt.js" }, bundles: { "q-8YGB9J3i.js": { size: 1187, imports: ["q-DicO215r.js"], origins: ["src/entry_icon.js", "src/s_i6deaticz8c.js"], symbols: ["s_i6dEatiCz8c"] }, "q-B4GBWNN9.js": { size: 228, imports: ["q-DicO215r.js"], dynamicImports: ["q-DiOoKElR.js"], origins: ["src/routes/blog/index.tsx"] }, "q-BeBV7ZS2.js": { size: 332, imports: ["q-DicO215r.js"], origins: ["src/entry_close.js", "src/s_drareqyzk0u.js"], symbols: ["s_drAReQyZk0U"] }, "q-BJ8p8H2g.js": { size: 571, imports: ["q-BVR9la9S.js", "q-Cb8Z2Z7l.js", "q-DicO215r.js"], origins: ["src/entry_navButton.js", "src/s_lnnfzjk390a.js", "src/s_nczeu0ro00k.js"], symbols: ["s_lNnfZJK390A", "s_NCzEU0RO00k"] }, "q-BLXmGQRh.js": { size: 358, imports: ["q-CB0WnyHC.js", "q-DicO215r.js"], origins: ["src/entry_paragraph.js", "src/s_yg7my3j7tgu.js"], symbols: ["s_yg7MY3J7tGU"] }, "q-Bov5xlCd.js": { size: 442, imports: ["q-DicO215r.js"], dynamicImports: ["q-DSWH9Y8W.js"], origins: ["src/routes/[...home]/index!.tsx"] }, "q-Bq36Wx9q.js": { size: 2539, origins: ["node_modules/@builder.io/qwik-city/service-worker.mjs", "src/routes/service-worker.ts"] }, "q-BupgBN2_.js": { size: 478, imports: ["q-BVR9la9S.js", "q-DicO215r.js"], dynamicImports: ["q-rTUtui2W.js"], origins: ["src/components/router-head/router-head.tsx", "src/entry_root.js", "src/s_tntnak2dhj8.js"], symbols: ["s_tntnak2DhJ8"] }, "q-BVR9la9S.js": { size: 7713, imports: ["q-DicO215r.js"], dynamicImports: ["q-CmuGpiU_.js", "q-D3WBTSLL.js", "q-gPfqXXgU.js"], origins: ["@qwik-city-sw-register", "node_modules/@builder.io/qwik-city/index.qwik.mjs"] }, "q-BYF81Q4t.js": { size: 985, imports: ["q-BVR9la9S.js", "q-DicO215r.js"], origins: ["src/entry_overview.js", "src/s_ckljc1fxmoo.js", "src/s_kxx7fivjwog.js"], symbols: ["s_Ckljc1FxMOo", "s_kxX7fiVjwOg"] }, "q-C-OXjSkJ.js": { size: 549, imports: ["q-Cb8Z2Z7l.js", "q-DicO215r.js"], dynamicImports: ["q-tHpHQCTg.js"], origins: ["src/components/columns/sidemenu.tsx", "src/entry_layout.js", "src/s_ati7niskh2g.js", "src/s_vkflawjuvm8.js"], symbols: ["s_ati7nisKH2g", "s_VKFlAWJuVm8"] }, "q-C0q0_ZTZ.js": { size: 546, imports: ["q-DicO215r.js"], origins: ["src/entry_home.js", "src/s_abp1tubnbsa.js"], symbols: ["s_abp1tubNbSA"] }, "q-C7JRSoZ_.js": { size: 159, imports: ["q-DicO215r.js"], origins: ["src/entry_break.js", "src/s_gdrt3qzp3eq.js"], symbols: ["s_GDRT3QzP3eQ"] }, "q-C8U2fkLG.js": { size: 125, imports: ["q-DicO215r.js"], dynamicImports: ["q-Bq36Wx9q.js"], origins: ["@qwik-city-entries"] }, "q-CB0WnyHC.js": { size: 136, imports: ["q-DicO215r.js"], dynamicImports: ["q-Dbb0mmIF.js"], origins: ["src/components/page/sections/title.tsx"] }, "q-Cb8Z2Z7l.js": { size: 972, origins: ["src/styleY.tsx"] }, "q-Cbdc-vfP.js": { size: 895, imports: ["q-BVR9la9S.js", "q-DicO215r.js"], origins: ["src/entry_serverQrl.js", "src/s_woipfiq04l4.js"], symbols: ["s_wOIPfiQ04l4"] }, "q-CciOo66m.js": { size: 816, imports: ["q-BVR9la9S.js", "q-DicO215r.js"], origins: ["src/entry_QwikCityMockProvider.js", "src/s_bubtvtyvvre.js", "src/s_wmyc5h00wti.js"], symbols: ["s_BUbtvTyvVRE", "s_WmYC5H00wtI"] }, "q-CJywxT-1.js": { size: 787, imports: ["q-DicO215r.js"], origins: ["src/entry_website.js", "src/s_rkuyv2qxcqk.js"], symbols: ["s_rkuYV2qXCqk"] }, "q-CmuGpiU_.js": { size: 457, imports: ["q-BVR9la9S.js", "q-DicO215r.js"], origins: ["src/entry_RouterOutlet.js", "src/s_e0ssidxoeam.js"], symbols: ["s_e0ssiDXoeAM"] }, "q-D3WBTSLL.js": { size: 2280, origins: ["src/entry_spaInit.js", "src/s_dyvc0ybiqqu.js"], symbols: ["s_DyVc0YBIqQU"] }, "q-Dbb0mmIF.js": { size: 359, imports: ["q-DicO215r.js"], origins: ["src/entry_title.js", "src/s_byjfogmmj5g.js"], symbols: ["s_BYJFogMmj5g"] }, "q-DFwGbhrM.js": { size: 1223, imports: ["q-BVR9la9S.js", "q-CB0WnyHC.js", "q-Cb8Z2Z7l.js", "q-DicO215r.js", "q-sa_hVeOs.js"], origins: ["src/entry__id_.js", "src/s_79brs3cztfk.js", "src/s_wciefdpqfc4.js"], symbols: ["s_79BRs3cztfk", "s_wCieFdpQfC4"] }, "q-DicO215r.js": { size: 50627, origins: ["node_modules/@builder.io/qwik/core.min.mjs"] }, "q-DiOoKElR.js": { size: 1601, imports: ["q-Cb8Z2Z7l.js", "q-DicO215r.js", "q-sa_hVeOs.js"], dynamicImports: ["q-BYF81Q4t.js"], origins: ["src/components/page/overview.tsx", "src/entry_blog.js", "src/s_9bx79psauli.js", "src/s_gbqbgbjvvwu.js", "src/s_te3w2ykiwwu.js"], symbols: ["s_9bX79PSaULI", "s_GBQBGBjVVwU", "s_Te3w2ykiWWU"] }, "q-DSWH9Y8W.js": { size: 730, imports: ["q-Bov5xlCd.js", "q-Cb8Z2Z7l.js", "q-DicO215r.js"], dynamicImports: ["q-Qv9c0kVt.js"], origins: ["src/components/buttons/primaryBtn.tsx", "src/entry_index_.js", "src/s_uj8rhq0ae0e.js"], symbols: ["s_uJ8rhQ0Ae0E"] }, "q-DWVAV1wy.js": { size: 245, imports: ["q-DicO215r.js"], dynamicImports: ["q-C-OXjSkJ.js"], origins: ["src/routes/[...home]/layout.tsx"] }, "q-gPfqXXgU.js": { size: 5716, imports: ["q-BVR9la9S.js", "q-DicO215r.js"], dynamicImports: ["q-B4GBWNN9.js", "q-Bov5xlCd.js", "q-C8U2fkLG.js", "q-DWVAV1wy.js", "q-KnhfnG_2.js", "q-MHjnwt1g.js"], origins: ["@qwik-city-plan", "src/entry_QwikCityProvider.js", "src/s_02wmimzeabk.js", "src/s_fx0bdjeja0e.js", "src/s_rpdjaz33wla.js", "src/s_txcfoy819ag.js"], symbols: ["s_02wMImzEAbk", "s_fX0bDjeJa0E", "s_RPDJAz33WLA", "s_TxCFOy819ag"] }, "q-k5DSPVCD.js": { size: 1601, imports: ["q-BVR9la9S.js", "q-DicO215r.js"], origins: ["src/entry_Link.js", "src/s_8gdlbszqbam.js", "src/s_osdg8fnytw4.js", "src/s_pif0khhuxfy.js"], symbols: ["s_8gdLBszqbaM", "s_Osdg8FnYTw4", "s_pIf0khHUxfY"] }, "q-KnhfnG_2.js": { size: 142, imports: ["q-DicO215r.js"], dynamicImports: ["q-DFwGbhrM.js"], origins: ["src/routes/blog/[id]/index.tsx"] }, "q-MHjnwt1g.js": { size: 245, imports: ["q-DicO215r.js"], dynamicImports: ["q-C-OXjSkJ.js"], origins: ["src/routes/layout.tsx"] }, "q-MpnuTtA2.js": { size: 190, imports: ["q-Cb8Z2Z7l.js", "q-DicO215r.js"], origins: ["src/entry_loading.js", "src/s_c3i542fyxnm.js"], symbols: ["s_C3I542fyxnM"] }, "q-NQ9uuYVL.js": { size: 511, imports: ["q-DicO215r.js"], origins: ["src/entry_auth.js", "src/s_hekvrfdtkxg.js"], symbols: ["s_hEKvrfdTKXg"] }, "q-Qv9c0kVt.js": { size: 594, imports: ["q-BVR9la9S.js", "q-DicO215r.js"], origins: ["src/entry_primaryBtn.js", "src/s_0jin91g00l8.js", "src/s_zkgg5xgsigs.js"], symbols: ["s_0jIn91G00l8", "s_zKGG5xGsigs"] }, "q-rTUtui2W.js": { size: 717, imports: ["q-BVR9la9S.js", "q-DicO215r.js"], origins: ["src/entry_RouterHead.js", "src/s_0vphqyqodzi.js"], symbols: ["s_0vphQYqOdZI"] }, "q-sa_hVeOs.js": { size: 23551, imports: ["q-DicO215r.js"], dynamicImports: ["q-MpnuTtA2.js"], origins: ["node_modules/appwrite/dist/esm/sdk.js", "node_modules/cross-fetch/dist/browser-ponyfill.js", "src/components/loading.tsx", "src/config/database.tsx"] }, "q-Szi5y3oT.js": { size: 751, imports: ["q-DicO215r.js"], origins: ["src/entry_routeActionQrl.js", "src/s_a5bzc7wo00a.js"], symbols: ["s_A5bZC7WO00A"] }, "q-tHpHQCTg.js": { size: 671, imports: ["q-DicO215r.js"], dynamicImports: ["q-BJ8p8H2g.js", "q-C0q0_ZTZ.js", "q-DiOoKElR.js"], origins: ["src/components/buttons/navButton.tsx", "src/entry_sidemenu.js", "src/icons/blog.tsx", "src/icons/home.tsx", "src/s_px8yqok5ags.js"], symbols: ["s_PX8yQoK5ags"] }, "q-W-DP7Nje.js": { size: 1157, imports: ["q-BVR9la9S.js", "q-DicO215r.js"], origins: ["src/entry_GetForm.js", "src/s_nk9plpjqm9y.js", "src/s_p9msze0ojs4.js"], symbols: ["s_Nk9PlpjQm9Y", "s_p9MSze0ojs4"] }, "q-ZGPeoosQ.js": { size: 142, imports: ["q-DicO215r.js"], dynamicImports: ["q-BupgBN2_.js"], origins: ["src/global.css", "src/root.tsx"] } }, injections: [{ tag: "style", location: "head", attributes: { "data-src": "/build/q-ajOWo7IF.css", dangerouslySetInnerHTML: `/*! tailwindcss v3.3.3 | MIT License | https://tailwindcss.com
 */*,:before,:after{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}:before,:after{--tw-content: ""}html{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;-o-tab-size:4;tab-size:4;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,"Apple Color Emoji","Segoe UI Emoji",Segoe UI Symbol,"Noto Color Emoji";font-feature-settings:normal;font-variation-settings:normal}body{margin:0;line-height:inherit}hr{height:0;color:inherit;border-top-width:1px}abbr:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;text-decoration:inherit}b,strong{font-weight:bolder}code,kbd,samp,pre{font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace;font-size:1em}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}table{text-indent:0;border-color:inherit;border-collapse:collapse}button,input,optgroup,select,textarea{font-family:inherit;font-feature-settings:inherit;font-variation-settings:inherit;font-size:100%;font-weight:inherit;line-height:inherit;color:inherit;margin:0;padding:0}button,select{text-transform:none}button,[type=button],[type=reset],[type=submit]{-webkit-appearance:button;background-color:transparent;background-image:none}:-moz-focusring{outline:auto}:-moz-ui-invalid{box-shadow:none}progress{vertical-align:baseline}::-webkit-inner-spin-button,::-webkit-outer-spin-button{height:auto}[type=search]{-webkit-appearance:textfield;outline-offset:-2px}::-webkit-search-decoration{-webkit-appearance:none}::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}summary{display:list-item}blockquote,dl,dd,h1,h2,h3,h4,h5,h6,hr,figure,p,pre{margin:0}fieldset{margin:0;padding:0}legend{padding:0}ol,ul,menu{list-style:none;margin:0;padding:0}dialog{padding:0}textarea{resize:vertical}input::-moz-placeholder,textarea::-moz-placeholder{opacity:1;color:#9ca3af}input::placeholder,textarea::placeholder{opacity:1;color:#9ca3af}button,[role=button]{cursor:pointer}:disabled{cursor:default}img,svg,video,canvas,audio,iframe,embed,object{display:block;vertical-align:middle}img,video{max-width:100%;height:auto}[hidden]{display:none}*,:before,:after{--tw-border-spacing-x: 0;--tw-border-spacing-y: 0;--tw-translate-x: 0;--tw-translate-y: 0;--tw-rotate: 0;--tw-skew-x: 0;--tw-skew-y: 0;--tw-scale-x: 1;--tw-scale-y: 1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness: proximity;--tw-gradient-from-position: ;--tw-gradient-via-position: ;--tw-gradient-to-position: ;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width: 0px;--tw-ring-offset-color: #fff;--tw-ring-color: rgb(59 130 246 / .5);--tw-ring-offset-shadow: 0 0 #0000;--tw-ring-shadow: 0 0 #0000;--tw-shadow: 0 0 #0000;--tw-shadow-colored: 0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: }::backdrop{--tw-border-spacing-x: 0;--tw-border-spacing-y: 0;--tw-translate-x: 0;--tw-translate-y: 0;--tw-rotate: 0;--tw-skew-x: 0;--tw-skew-y: 0;--tw-scale-x: 1;--tw-scale-y: 1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness: proximity;--tw-gradient-from-position: ;--tw-gradient-via-position: ;--tw-gradient-to-position: ;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width: 0px;--tw-ring-offset-color: #fff;--tw-ring-color: rgb(59 130 246 / .5);--tw-ring-offset-shadow: 0 0 #0000;--tw-ring-shadow: 0 0 #0000;--tw-shadow: 0 0 #0000;--tw-shadow-colored: 0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: }.container{width:100%}@media (min-width: 640px){.container{max-width:640px}}@media (min-width: 768px){.container{max-width:768px}}@media (min-width: 1024px){.container{max-width:1024px}}@media (min-width: 1280px){.container{max-width:1280px}}@media (min-width: 1536px){.container{max-width:1536px}}.m-1{margin:.25rem}.m-2{margin:.5rem}.m-3{margin:.75rem}.m-4{margin:1rem}.m-8{margin:2rem}.mx-12{margin-left:3rem;margin-right:3rem}.mx-4{margin-left:1rem;margin-right:1rem}.mt-4{margin-top:1rem}.mt-6{margin-top:1.5rem}.flex{display:flex}.h-1{height:.25rem}.h-5\\/6{height:83.333333%}.h-9{height:2.25rem}.h-full{height:100%}.h-screen{height:100vh}.max-h-\\[100vh\\]{max-height:100vh}.w-1\\/5{width:20%}.w-3\\/5{width:60%}.w-4\\/5{width:80%}.w-9{width:2.25rem}.w-full{width:100%}.w-screen{width:100vw}.max-w-2xl{max-width:42rem}.max-w-\\[70px\\]{max-width:70px}.max-w-sm{max-width:24rem}.cursor-default{cursor:default}.cursor-pointer{cursor:pointer}.select-none{-webkit-user-select:none;-moz-user-select:none;user-select:none}.flex-col{flex-direction:column}.items-center{align-items:center}.justify-end{justify-content:flex-end}.justify-center{justify-content:center}.overflow-hidden{overflow:hidden}.overflow-scroll{overflow:scroll}.overflow-x-hidden{overflow-x:hidden}.rounded{border-radius:.25rem}.rounded-md{border-radius:.375rem}.border-4{border-width:4px}.border-LIGHT-txtPrimary{border-color:var(--primary)}.bg-LIGHT-txtSecondary{background-color:var(--txt-secondary)}.bg-transparent{background-color:transparent}.stroke-LIGHT-txtPrimary{stroke:var(--primary)}.p-2{padding:.5rem}.p-4{padding:1rem}.px-12{padding-left:3rem;padding-right:3rem}.px-20{padding-left:5rem;padding-right:5rem}.pb-4{padding-bottom:1rem}.pt-4{padding-top:1rem}.text-center{text-align:center}.text-2xl{font-size:1.5rem;line-height:2rem}.text-5xl{font-size:3rem;line-height:1}.text-6xl{font-size:3.75rem;line-height:1}.text-base{font-size:1rem;line-height:1.5rem}.text-lg{font-size:1.125rem;line-height:1.75rem}.font-bold{font-weight:700}.font-extrabold{font-weight:800}.font-semibold{font-weight:600}.italic{font-style:italic}.shadow-border{--tw-shadow: 4px 4px var(--primary), -4px -4px var(--primary);--tw-shadow-colored: 4px 4px var(--tw-shadow-color), -4px -4px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000),var(--tw-ring-shadow, 0 0 #0000),var(--tw-shadow)}.shadow-header{--tw-shadow: 0px 3px var(--primary), 0px -3px var(--primary);--tw-shadow-colored: 0px 3px var(--tw-shadow-color), 0px -3px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000),var(--tw-ring-shadow, 0 0 #0000),var(--tw-shadow)}:root{--dark-background: #00000a;--dark-bg-secondary: #000025;--dark-primary: #dcdcdc;--dark-txt-secondary: #cdcdcd;--background: #dcdcdc;--bg-secondary: #adacac;--primary: #00000a;--txt-secondary: #000025;--warning: "bg-red-600";background-color:var(--background);color:var(--primary)}.hover\\:bg-LIGHT-bgSecondary:hover{background-color:var(--bg-secondary)}@media (min-width: 640px){.sm\\:hidden{display:none}.sm\\:max-w-\\[70px\\]{max-width:70px}}@media (min-width: 768px){.md\\:flex{display:flex}}
...
var Ve2 = Un(Lt(Ke2, "s_0vphQYqOdZI"));
...
function $e2(t) {
  return Ee2(ft(Me2, null, 3, "Qb_0"), { manifest: Le2, ...t, containerAttributes: { lang: "en-us", ...t.containerAttributes } });
}
init_checked_fetch();
init_modules_watch_stub();
init_checked_fetch();
...
var H2 = ["flex", "w-full", "max-h-[100vh]", "justify-center", "overflow-hidden", "scrollbar-hidden"];
var N3 = ["p-4", "flex", "mt-4", "w-full", "flex-col", "h-screen", "rounded-md", "items-center", "shadow-border", "scrollbar-hidden"];
var k = ["m-8", "mx-12", "max-w-2xl", "overflow-scroll", "scrollbar-hidden", "overflow-x-hidden"];
var Q2 = ["w-screen", "h-screen", "flex", "items-center", "flex-col", "justify-center"];
var L2 = ["flex", "h-5/6", "font-bold", "text-6xl", "text-center", "justify-center", "items-center"];
var O2 = ["flex", "cursor-default", "text-2xl", "px-20", "text-center", "items-center", "pb-4", "justify-center", "select-none"];
var V2 = ["m-2", "italic", "text-2xl", "text-center", "font-semibold", "shadow-header", "text-align: center"];
var F2 = ["m-3", "flex", "rounded", "border-4", "items-center", "border-LIGHT-txtPrimary", "justify-center", "hover:bg-LIGHT-bgSecondary"];
var W2 = ["m-4", "h-1", "rounded", "bg-LIGHT-txtSecondary"];
var A2 = ["m-4", "p-4", "text-lg", "shadow-border"];
var K2 = (e) => {
  const l = k$();
  return xt("div", null, { class: F2, onClick$: x$("s_lNnfZJK390A", [l, e]) }, y$((o) => o.icon, [e], "p0.icon"), 3, "tW_0");
};
var h = Un(Lt(K2, "s_NCzEU0RO00k"));
...
var J3 = Un(Lt(E, "s_PX8yQoK5ags"));
var $ = async ({ cacheControl: e }) => {
  e({ staleWhileRevalidate: 604800, maxAge: 5 });
};
var X2 = () => xt("div", null, { class: H2 }, [xt("div", { class: [["w-1/5", "flex", "justify-end", "items-center", "sm:max-w-[70px]"], ["sm:hidden md:flex"]] }, null, null, 3, null), xt("div", { class: ["flex", "w-4/5", "h-full", "m-4"] }, null, xt("div", null, { class: N3 }, ft(xe, null, 3, "yB_0"), 1, null), 1, null), ft(J3, null, 3, "yB_1")], 1, "yB_2");
var D2 = Un(Lt(X2, "s_VKFlAWJuVm8"));
var Z3 = Object.freeze(Object.defineProperty({ __proto__: null, default: D2, onGet: $ }, Symbol.toStringTag, { value: "Module" }));
var S2 = { url: "https://appwrite.domcogan.app/v1", projectId: "6621bd6a00282722c88e", databasesId: "6621bdfa001d92f8fa33", blogCollectionId: "6622e812003c292dedb5", itemCollectionId: "662444e20028c21a42fd", sectionCollectionId: "662451cc003b8feca015" };
var f = new Client();
f.setProject(S2.projectId);
f.setEndpoint(S2.url);
new Databases(f);
var Y2 = (e) => {
...
var te3 = (e) => xt("div", null, { class: L2 }, ["Loading ", y$((l) => l.message, [e], "p0.message"), "..."], 3, "qE_0");
var B2 = Un(Lt(te3, "s_C3I542fyxnM"));
var le2 = () => {
  si();
  ...
  return w$(x$("s_9bX79PSaULI", [e])), xt("div", null, { class: k }, e.blogPosts.length > 0 ? e.blogPosts.map((l) => ft(ee3, { get title() {
    ...
    return l.overview;
  }, [M]: { title: ii(l, "title"), id: ii(l, "id"), description: ii(l, "overview") } }, 3, l.id)) : ft(B2, { message: "list of blogs", [M]: { message: M } }, 3, "B0_0"), 1, "B0_1");
};
var ne3 = Un(Lt(le2, "s_GBQBGBjVVwU"));
var oe2 = { meta: [{ name: "Blog", content: "These are the blogs that I have uploaded" }] };
var se2 = Object.freeze(Object.defineProperty({ __proto__: null, default: ne3, head: oe2 }, Symbol.toStringTag, { value: "Module" }));
var ae2 = (e) => {
...
var re2 = () => {
  ...
  }, [M]: { text: y$((s) => s.blogPost.title, [o], "p0.blogPost.title") } }, 3, "4y_0"), o.blogPost.sections.map((s) => xt("div", null, { class: A2 }, s.pageSections.map((u) => xt("div", { class: [u.type === "header" ? V2 : u.type === "break" ? W2 : ""] }, null, ci(u, "content"), 1, u.type)), 1, s.id))] }, 1, "4y_1") : ft(B2, { message: "blog", [M]: { message: M } }, 3, "4y_2"), 1, "4y_3");
};
...
var de2 = (e) => {
  const l = k$();
  return xt("div", { class: ["mx-4", "pt-4", "pb-4", "px-12", "text-2xl", "shadow-border", "cursor-pointer", "border-box", "hover:bg-hover"] }, { onClick$: x$("s_zKGG5xGsigs", [l, e]) }, y$((s) => s.text, [e], "p0.text"), 3, "fv_0");
};
var ge2 = Un(Lt(de2, "s_0jIn91G00l8"));
var xe3 = () => xt("div", null, { class: Q2 }, [xt("h1", null, { class: ["p-4", "text-center", "text-6xl", "font-extrabold"] }, "Hello & Welcome", 3, null), xt("p", null, { class: O2 }, "First off, thank you for visiting. My name is Dom Cogan, and this is my portfolio website. I did not attend college. In my spare time, I love learning new skills, I've taught myself Flutter, Qwik, Next.js, and CSS.", 3, null), xt("div", null, { class: P2 }, ft(ge2, { text: "Blog", link: "blog", [M]: { text: M, link: M } }, 3, "Vi_0"), 1, null)], 1, "Vi_1");
...
var P2 = ["flex", "justify-center", "items-center", "select-none"];
var _e3 = Object.freeze(Object.defineProperty({ __proto__: null, _auto_row: P2, default: me2, head: fe2 }, Symbol.toStringTag, { value: "Module" }));
var be3 = [];
var v = () => Z3;
var he2 = [["blog/", [v, () => se2], "/blog/", ["q-MHjnwt1g.js", "q-B4GBWNN9.js"]], ["blog/[id]/", [v, () => ue2], "/blog/[id]/", ["q-MHjnwt1g.js", "q-KnhfnG_2.js"]], ["[...home]", [() => _e3], "/[...home]", ["q-Bov5xlCd.js"]]];
var ve3 = [];
var we2 = true;
var pe2 = "/";
var ye3 = true;
var Se3 = { routes: he2, serverPlugins: be3, menus: ve3, trailingSlash: we2, basePathname: pe2, cacheModules: ye3 };
...
var Qe3 = class {
  constructor(e) {
    this[oe3] = {}, this[ce3] = {}, this[k2] = He2(e), this[_] = { ...this[k2] };
  }
  get(e, t = true) {
...
function it2(e, t, n, r, a, i, s, o) {
  ...
  g.pathname.endsWith(x) && (g.pathname = g.pathname.slice(0, -ge3), a && !g.pathname.endsWith("/") && (g.pathname += "/"), h2.set(P3, true)), h2.set("@manifest", r);
  let w = -1, y = null, A3, T2 = e.locale, S3 = 200;
  const Se4 = async () => {
    for (w++; w < n.length; ) {
    ...
    } else if (S3 = f2.status, f2.headers.forEach((b, D3) => {
      u.append(D3, b);
    }), f2.body) {
    ...
    return U2();
  }, U2 = () => (w = E2, new B3()), z3 = {}, R2 = { [fe3]: z3, [ue3]: e.mode, [he3]: a, [de3]: t, [L3]: s, cookie: m, headers: u, env: d, method: l.method, signal: l.signal, params: (t == null ? void 0 : t[1]) ?? {}, pathname: g.pathname, platform: c, query: g.searchParams, request: l, url: g, basePathname: i, sharedMap: h2, get headersSent() {
    return y !== null;
  }, get exited() {
    return w >= E2;
  }, get clientConn() {
    ...
    if (f2.__brand === "server_loader" && !(p in z3))
      throw new Error("You can not get the returned data of a loader that has not been executed for this request.");
    return z3[p];
  }, status: (f2) => typeof f2 == "number" ? (C2(), S3 = f2, f2) : S3, locale: (f2) => (typeof f2 == "string" && (T2 = f2), T2 || ""), error: (f2, p) => (S3 = f2, u.delete("Cache-Control"), new ie3(f2, p)), redirect: (f2, p) => {
    if (C2(), S3 = f2, p) {
  ...
  }, defer: (f2) => typeof f2 == "function" ? f2 : () => f2, fail: (f2, p) => (C2(), S3 = f2, u.delete("Cache-Control"), { failed: true, ...p }), text: (f2, p) => (u.set("Content-Type", "text/plain; charset=utf-8"), M2(f2, p)), html: (f2, p) => (u.set("Content-Type", "text/html; charset=utf-8"), M2(f2, p)), parseBody: async () => A3 !== void 0 ? A3 : A3 = ot2(R2.request, h2, s), json: (f2, p) => (u.set("Content-Type", "application/json; charset=utf-8"), M2(f2, JSON.stringify(p))), send: M2, isDirty: () => y !== null, getWritableStream: () => {
    if (y === null) {
      if (e.mode === "dev") {
  ...
  async function n(r, a, i) {
    try {
      ...
      const h2 = await wt2({ mode: "server", locale: void 0, url: s, request: r, env: { get(u) {
        ...
        const { readable: A3, writable: T2 } = new TransformStream(), S3 = new Response(A3, { status: u, headers: Ue3(g, w) });
        return y(S3), T2;
...
var Pt2 = St2({ render: $e2, qwikCityPlan: Se3, manifest: Le2 });
...
// .wrangler/tmp/pages-mXYl3h/ibtrji686i.js
...
// .wrangler/tmp/bundle-0pAHWy/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-0pAHWy/middleware-loader.entry.ts
