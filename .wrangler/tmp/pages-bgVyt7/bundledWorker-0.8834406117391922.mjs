...
// ../.wrangler/tmp/bundle-Xx9N9V/checked-fetch.js
...
var lr = (t, e, n, s, o, r, i) => (ur(t, s, o.props.props), I(fe(t, s), (c) => {
  ...
  return s.$id$ = m, e.$static$.$contexts$.push(s), ks(b2, s, d, l, f2, n, r, (u) => {
    if (s.$flags$ & ht) {
      ...
      for (const x3 of E3) {
        const v2 = Ps(x3[0]);
        w[v2] = Fn(x3[1], t.$static$.$containerState$, g), Ke(v2, t.$static$.$containerState$);
      }
      Sn("script", w, u);
    }
    ...
    let S3;
    if (p2) {
      const g = Object.keys(p2).map((x3) => {
        const v2 = p2[x3];
        if (v2)
          return xt("q:template", { [G]: x3 || true, hidden: true, "aria-hidden": "true" }, null, v2, 0, null);
...
var vn = (t, e, n, s, o, r) => {
  ...
  if (typeof i == "string") {
    ...
    const w = (v2, _2, q3) => {
      ...
      if (dn(v2))
        return void hn(m.li, v2, _2, void 0);
      if (C(_2) && (_2 = it(_2, q3 ? [1, y, _2, c.$element$, v2] : [2, c.$element$, _2, y, v2]), p2 = true), v2 === D)
        return void (h = _2);
      let R2;
    ...
    for (const v2 in f2) {
      let _2 = false, q3;
      v2 in d ? (_2 = true, q3 = d[v2], q3 === M && (q3 = f2[v2])) : q3 = f2[v2], w(v2, q3, _2);
    }
    for (const v2 in d) {
      if (v2 in f2)
        continue;
  ...
  if (t.$slotCtx$ ? (m.$parentCtx$ = t.$slotCtx$, m.$realParentCtx$ = t.$cmpCtx$) : m.$parentCtx$ = t.$cmpCtx$, l) {
    if ("q:renderFn" in a) {
      ...
      const w = I(wn(t, m, n), () => {
        ...
        const x3 = co(m), v2 = [], _2 = oo(E3);
        for (const q3 in _2) {
          const R2 = _2[q3], k3 = io(f2, x3, m, q3, f2.$containerState$), st2 = oe(t), kt = k3.$element$;
...
var Bi = async (t, e, n, s) => {
  ...
  for (const h of t) {
    ...
    for (const x3 of E3)
      if (St(w)) {
        const v2 = x3[1], _2 = v2.$captureRef$;
        if (_2)
          for (const q3 of _2)
            T(q3, o, true);
  ...
  const $3 = /* @__PURE__ */ new Map(), l = Array.from(o.$objSet$.keys()), a = /* @__PURE__ */ new Map(), f2 = (h) => {
    ...
    if (E3)
      return E3 + w;
    const x3 = s == null ? void 0 : s.get(h);
    return x3 ? "*" + x3 : n ? n(h) : null;
  }, d = (h) => {
    const w = f2(h);
    if (w === null) {
      if (Wn(h)) {
  ...
  for (const h of l) {
    ...
    for (const v2 of w) {
      const _2 = v2[1];
      v2[0] === 0 && yt(_2) && nt(_2) && !o.$elements$.includes(X(_2)) || x3.push(v2);
    }
    x3.length > 0 && m.set(h, x3);
  }
  ...
  for (const h of t) {
    const w = h.$element$, E3 = h.$id$, x3 = h.$refMap$, v2 = h.$props$, _2 = h.$contexts$, q3 = h.$tasks$, R2 = h.$componentQrl$, k3 = h.$seq$, st2 = {}, kt = nt(w) && o.$elements$.includes(h);
    if (x3.length > 0) {
      const U2 = wt(x3, d, " ");
      U2 && (S3[E3] = U2);
    } else if (c) {
      ...
      if (p2 && !p2.hasAttribute("preventdefault:click")) {
        ...
        if (w && E3)
          if (u.preventDefault(), h.href !== g.href && history.pushState(null, "", h), !h.hash)
            ...
            const x3 = h.hash.slice(1), v2 = document.getElementById(x3);
...
var p$ = ({ track: t }) => {
  ...
  async function d() {
    ...
    if (g = new URL(y.dest, f2.url), w = r.loadedRoute, h = r.response, w) {
      const [E3, x3, v2, _2] = w, q3 = v2, R2 = q3[q3.length - 1];
      f2.prevUrl = p2, f2.url = g, f2.params = { ...x3 }, a.untrackedValue = { type: S3, dest: g };
...
function G2(t, e) {
  ...
  return { isServer: true, async importSymbol(i, a, o) {
    var _2;
    const c = z(o), d = (_2 = globalThis.__qwik_reg_symbols) == null ? void 0 : _2.get(c);
    if (d)
      return d;
    let u = String(a);
    u.endsWith(".js") || (u += ".js");
...
function ze2(t, e, n) {
  const s = Oe2(t == null ? void 0 : t.implementation), r = [];
  return s.prefetchEvent === "always" && Ce2(r, e, n), s.linkInsert === "html-append" && Ee2(r, e, s), s.linkInsert === "js-append" ? Be2(r, e, s, n) : s.workerFetchInsert === "always" && Ae2(r, e, n), r.length > 0 ? v$(he, { children: r }) : null;
}
function Ce2(t, e, n) {
  const s = Se2(e);
  for (const r of s)
...
async function Le2(t, e) {
  ...
  const d = ((I4 = e.streaming) == null ? void 0 : I4.inOrder) ?? { strategy: "auto", maximunInitialChunk: 5e4, maximunChunk: 3e4 }, u = e.containerTagName ?? "html", q3 = e.containerAttributes ?? {}, _2 = n, se3 = S(), ie3 = ee2(e), p2 = ne2(e.manifest);
  function B4() {
  ...
  switch (d.strategy) {
    ...
    case "auto":
      let l = 0, f2 = false;
      const Q4 = d.maximunChunk ?? 0, v2 = d.maximunInitialChunk ?? 0;
      n = { write(b2) {
        b2 === "<!--qkssr-f-->" ? f2 || (f2 = true) : b2 === "<!--qkssr-pu-->" ? l++ : b2 === "<!--qkssr-po-->" ? l-- : A3(b2), l === 0 && (f2 || s >= (i === 0 ? v2 : Q4)) && (f2 = false, B4());
      } };
      break;
  }
  ...
  const O4 = p2 == null ? void 0 : p2.manifest.injections, k3 = O4 ? O4.map((l) => v$(l.tag, l.attributes ?? {})) : [], j3 = ((T3 = e.qwikLoader) == null ? void 0 : T3.include) ?? "auto";
  if ((((P4 = e.qwikLoader) == null ? void 0 : P4.position) ?? "bottom") === "top" && j3 !== "never") {
  ...
  const re3 = S(), F4 = [];
  let D3 = 0, L4 = 0;
  await g$(t, { stream: n, containerTagName: u, containerAttributes: q3, serverData: e.serverData, base: ie3, beforeContent: k3, beforeClose: async (l, f2, Q4, v2) => {
    var K4, U2, W4, M3, H4;
    D3 = re3();
    const b2 = S();
    c = await Bi(l, f2, void 0, v2);
    const y = [];
    if (e.prefetchStrategy !== null) {
      const w = ke2(c, e, p2);
      if (w.length > 0) {
        const $3 = ze2(e.prefetchStrategy, w, (K4 = e.serverData) == null ? void 0 : K4.nonce);
        $3 && y.push($3);
      }
    }
    const ae3 = JSON.stringify(c.state, void 0, void 0);
    y.push(v$("script", { type: "qwik/json", dangerouslySetInnerHTML: Ie2(ae3), nonce: (U2 = e.serverData) == null ? void 0 : U2.nonce })), c.funcs.length > 0 && y.push(v$("script", { "q:func": "qwik/json", dangerouslySetInnerHTML: Qe2(c.funcs), nonce: (W4 = e.serverData) == null ? void 0 : W4.nonce }));
    const ce3 = !c || c.mode !== "static", R2 = j3 === "always" || j3 === "auto" && ce3;
    if (R2) {
      const w = Y2({ debug: e.debug });
      y.push(v$("script", { id: "qwikloader", dangerouslySetInnerHTML: w, nonce: (M3 = e.serverData) == null ? void 0 : M3.nonce }));
    }
    const V4 = Array.from(f2.$events$, (w) => JSON.stringify(w));
    if (V4.length > 0) {
      const w = (R2 ? "window.qwikevents" : "(window.qwikevents||=[])") + `.push(${V4.join(", ")})`;
      y.push(v$("script", { dangerouslySetInnerHTML: w, nonce: (H4 = e.serverData) == null ? void 0 : H4.nonce }));
    }
    return Te2(F4, l), L4 = b2(), v$(he, { children: y });
  }, manifestHash: (p2 == null ? void 0 : p2.manifest.manifestHash) || "dev" }), u !== "html" && n.write("<!--/cq-->"), B4();
  const oe4 = c.resources.some((l) => l._cache !== 1 / 0);
  return { prefetchResources: void 0, snapshotResult: c, flushes: i, manifest: p2 == null ? void 0 : p2.manifest, size: r, isStatic: !oe4, timing: { render: D3, snapshot: L4, firstFlush: a }, _symbols: F4 };
}
function ne2(t) {
  if (t) {
    if ("mapper" in t)
...
var Ie2 = (t) => t.replace(/<(\/?script)/gi, "\\x3C$1");
function Te2(t, e) {
  var n;
  for (const s of e) {
...
var Ke2 = Un(Lt(Ve2, "s_0vphQYqOdZI"));
var Ue2 = () => ft(R$, { children: [xt("head", null, null, [xt("meta", null, { charSet: "utf-8" }, null, 3, null), xt("link", null, { rel: "manifest", href: "/manifest.json" }, null, 3, null), ft(Ke2, null, 3, "vp_0")], 1, null), xt("body", null, { lang: "en" }, [ft(T$, null, 3, "vp_1"), ft(A$, null, 3, "vp_2")], 1, null)] }, 1, "vp_3");
var We2 = Un(Lt(Ue2, "s_tntnak2DhJ8"));
function Xe2(t) {
...
var V2 = () => xt("div", { class: ["w-1/5", "flex", "flex-col", "justify-center", "max-w-[70px]"] }, null, [ft(b, { get icon() {
  return v$(C3, {});
}, [M]: { icon: M } }, 3, "Tj_0"), ft(b, { get icon() {
  return v$(O2, {});
}, link: "blog", [M]: { icon: M, link: M } }, 3, "Tj_1")], 1, "Tj_2");
var M2 = Un(Lt(V2, "s_PX8yQoK5ags"));
var T2 = async ({ cacheControl: e }) => {
  e({ staleWhileRevalidate: 604800, maxAge: 5 });
};
var A2 = () => xt("div", null, { class: k }, [xt("div", { class: [["w-1/5", "flex", "justify-end", "items-center", "sm:max-w-[70px]"], ["sm:hidden md:flex"]] }, null, null, 3, null), xt("div", { class: ["flex", "w-4/5", "h-full", "m-4"] }, null, xt("div", null, { class: B2 }, ft(xe, null, 3, "yB_0"), 1, null), 1, null), ft(M2, null, 3, "yB_1")], 1, "yB_2");
var W2 = Un(Lt(A2, "s_VKFlAWJuVm8"));
var L2 = Object.freeze(Object.defineProperty({ __proto__: null, default: W2, onGet: T2 }, Symbol.toStringTag, { value: "Module" }));
var N2 = (e) => {
  const n = k$(), r = ["p-2", "m-1", "flex", "flex-col", "max-w-sm", "rounded-2xl", "cursor-pointer", e.bgColor ? e.bgColor : "bg-transparent", "hover:bg-hover", "box-border", "shadow-border"], c = ["flex", "italic", "w-full", "text-2xl", "font-bold", "text-center", "select-none", "justify-center", e.txColor ? e.txColor : "text-txPrimary"], x3 = ["text-base", "mt-6", "select-none"];
  return xt("div", { class: r }, { onClick$: x$("s_kxX7fiVjwOg", [n, e]) }, [e.image ? xt("div", null, null, null, 3, "BN_0") : ft(he, null, 3, "BN_1"), xt("div", null, null, [xt("div", { class: c }, null, y$((a) => a.title, [e], "p0.title"), 3, null), xt("div", { class: x3 }, null, y$((a) => a.description, [e], "p0.description"), 3, null)], 1, null)], 1, e.key);
};
var U = Un(Lt(N2, "s_Ckljc1FxMOo"));
var z2 = () => {
  const e = le({ blogPosts: [] });
  return w$(x$("s_9bX79PSaULI", [e])), xt("div", null, null, e.blogPosts.length > 0 ? e.blogPosts.map((n) => ft(U, { get title() {
    return n.title;
  }, get id() {
    return n.id;
  }, get description() {
...
var F2 = Un(Lt(z2, "s_GBQBGBjVVwU"));
var K2 = { meta: [{ name: "Blog", content: "These are the blogs that I have uploaded" }] };
var E = Object.freeze(Object.defineProperty({ __proto__: null, default: F2, head: K2 }, Symbol.toStringTag, { value: "Module" }));
var G3 = () => {
  const n = I$().params.id;
  return ft(he, { children: [xt("div", null, null, "Single blog post ", 3, null), xt("div", null, null, n, 1, null)] }, 1, "4y_0");
};
var H2 = Un(Lt(G3, "s_wCieFdpQfC4"));
var I2 = { title: "Welcome to Qwik", meta: [{ name: "description", content: "Qwik site description" }] };
var R = Object.freeze(Object.defineProperty({ __proto__: null, default: H2, head: I2 }, Symbol.toStringTag, { value: "Module" }));
var $ = () => ft(he, { children: xt("div", null, { class: p }, "Site Under Construction", 3, null) }, 3, "Vi_0");
var q = Un(Lt($, "s_uJ8rhQ0Ae0E"));
var J2 = { title: "Dom Cogan Portfolio", meta: [{ name: "description", content: "This is the portfolio website made in Qwik for Dom-Cogan" }] };
var X2 = Object.freeze(Object.defineProperty({ __proto__: null, default: q, head: J2 }, Symbol.toStringTag, { value: "Module" }));
var Z2 = [];
var f = () => L2;
var D2 = [["blog/", [f, () => E], "/blog/", ["q-B6XEZChI.js", "q-Blp1VViy.js"]], ["blog/[id]/", [f, () => R], "/blog/[id]/", ["q-B6XEZChI.js", "q-DB7APCB5.js"]], ["[...home]", [() => X2], "/[...home]", ["q-Be2jxJzO.js"]]];
var Y3 = [];
var ee3 = true;
var te3 = "/";
var ne3 = true;
var oe2 = { routes: D2, serverPlugins: Z2, menus: Y3, trailingSlash: ee3, basePathname: te3, cacheModules: ne3 };
...
var je3 = (e, t, n, r, a) => {
  ...
  if (e && V3(i, s, o, e, l, n), t) {
    const c = t[0];
    r && (n === "POST" || n === "PUT" || n === "PATCH" || n === "DELETE") && o.unshift(Ye3), l && (n === "POST" && o.push(Xe3), o.push(Ge2), o.push(Ee3)), o.push(qe3), V3(i, s, o, t[2], l, n), l && (o.push((d) => {
...
Make sure your <form> has method="POST" attribute, like this: <form method="POST">`), r === "POST") {
    ...
    e.length > 0 && await Promise.all(e.map((o) => {
      const l = o.__id;
      return a[l] = Z3(n, o.__validators, void 0, i).then((c) => c.success ? i ? N3(n, o.__qrl.getSymbol().split("_", 1)[0], () => o.__qrl.call(n, n)) : o.__qrl.call(n, n) : n.fail(c.status ?? 500, c.error)).then((c) => (typeof c == "function" ? a[l] = c() : (i && O3(s, c, o.__qrl), a[l] = c), c));
    }));
  };
}
...
function it2(e, t, n, r, a, i, s, o) {
  ...
  g.pathname.endsWith(x2) && (g.pathname = g.pathname.slice(0, -ge3), a && !g.pathname.endsWith("/") && (g.pathname += "/"), h.set(P3, true)), h.set("@manifest", r);
  ...
  const Se3 = async () => {
    ...
    if (f2.__brand === "server_loader" && !(p2 in z3))
      throw new Error("You can not get the returned data of a loader that has not been executed for this request.");
    return z3[p2];
  }, status: (f2) => typeof f2 == "number" ? (C4(), S3 = f2, f2) : S3, locale: (f2) => (typeof f2 == "string" && (T3 = f2), T3 || ""), error: (f2, p2) => (S3 = f2, u.delete("Cache-Control"), new ie2(f2, p2)), redirect: (f2, p2) => {
    if (C4(), S3 = f2, p2) {
  ...
  }, defer: (f2) => typeof f2 == "function" ? f2 : () => f2, fail: (f2, p2) => (C4(), S3 = f2, u.delete("Cache-Control"), { failed: true, ...p2 }), text: (f2, p2) => (u.set("Content-Type", "text/plain; charset=utf-8"), M3(f2, p2)), html: (f2, p2) => (u.set("Content-Type", "text/html; charset=utf-8"), M3(f2, p2)), parseBody: async () => A3 !== void 0 ? A3 : A3 = ot2(R2.request, h, s), json: (f2, p2) => (u.set("Content-Type", "application/json; charset=utf-8"), M3(f2, JSON.stringify(p2))), send: M3, isDirty: () => y !== null, getWritableStream: () => {
    if (y === null) {
      if (e.mode === "dev") {
...
var Pt2 = St2({ render: Xe2, qwikCityPlan: oe2, manifest: Re2 });
...
// ../.wrangler/tmp/bundle-Xx9N9V/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Xx9N9V/middleware-loader.entry.ts
...
* found in the LICENSE file at https://github.com/BuilderIO/qwik/blob/main/LICENSE
*/
//# sourceMappingURL=bundledWorker-0.8834406117391922.mjs.map
