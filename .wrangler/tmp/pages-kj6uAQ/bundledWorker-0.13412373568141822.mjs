...
// ../.wrangler/tmp/bundle-c1Pctd/checked-fetch.js
...
// ../.wrangler/tmp/bundle-c1Pctd/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// ../.wrangler/tmp/bundle-c1Pctd/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
var g$ = async (t, e) => {
  ...
  const a2 = { ...e.containerAttributes, "q:container": "paused", "q:version": "1.5.2", "q:render": l, "q:base": e.base, "q:locale": (b2 = e.serverData) == null ? void 0 : b2.locale, "q:manifest-hash": e.manifestHash }, f2 = n === "html" ? [t] : [c, t];
...
var qs = (t, e, n, s, o, r, i, c) => {
  ...
  f2 && ((b2 = s.$cmpCtx$) == null || b2.$id$, a2 += " q:sref=" + s.$cmpCtx$.$id$), d != null && (a2 += " q:key=" + d), a2 += "-->", r.write(a2);
  const m = t.props[D];
  if (m)
  ...
  return I(y, () => {
    ...
    let u;
    if (f2) {
      const S = (p = o.$projectedChildren$) == null ? void 0 : p[d];
      if (S) {
        const [g, h] = o.$projectedCtxs$, w = oe(g);
        w.$slotCtx$ = e, o.$projectedChildren$[d] = void 0, u = X(S, w, h, r, i);
      }
    }
...
var cr = (t, e, n, s, o, r, i) => (lr(t, s, o.props.props), I(fe(t, s), (c) => {
  ...
  const m = Jt(t), y = s.$scopeIds$ ? xs(s.$scopeIds$) : void 0, b2 = ft(o.type, { "q:sstyle": y, "q:id": m, children: c.node }, 0, o.key);
  return s.$id$ = m, e.$static$.$contexts$.push(s), qs(b2, s, d, l, f2, n, r, (u) => {
    if (s.$flags$ & ht) {
      const g = pe(1), h = g.li;
    ...
    if (p) {
      ...
      E3.$slotCtx$ = s, S = X(g, E3, w, u, 0, void 0);
    }
    return i ? I(S, () => i(u)) : S;
  });
}));
...
var yn = (t, e, n, s, o, r) => {
  ...
  if (typeof i == "string") {
    const a2 = t.key, f2 = t.props, d = t.immutableProps || O, m = pe(1), y = m.$element$, b2 = i === "head";
    let u = "<" + i, p = false, S = false, g = "", h = null;
    const w = (v3, _3, q3) => {
      if (v3 === "ref")
        return void (_3 !== void 0 && (kn(_3, y), S = true));
      if (un(v3))
    ...
    if (b2 && (o |= 1), i in ar && (o |= 16), i in ur && (o |= 8), g && (u += ' class="' + Ue(g) + '"'), E3.length > 0) {
    ...
    if (a2 != null && (u += ' q:key="' + Ue(a2) + '"'), S || p || E3.length > 0) {
      if (S || p || mr(E3)) {
        const v3 = Jt(e);
        u += ' q:id="' + v3 + '"', m.$id$ = v3;
      }
...
var br = (t) => {
  ...
  for (; c = l.nextNode(); ) {
    ...
    if ($3 === 0) {
      if (u.startsWith("qv ")) {
        ...
        const p = u.slice(2), S = Z(p), g = Tr(c);
        r.set(S, g), i.set(S, g.data);
      }
    }
    u === "cq" ? $3++ : u === "/cq" && $3--;
  }
  ...
  t.querySelectorAll("[q\\:id]").forEach((u) => {
    if (a2 && u.closest("[q\\:container]") !== t)
      return;
    const p = Y(u, "q:id"), S = Z(p);
    r.set(S, u);
  });
  const f2 = So(o, n), d = /* @__PURE__ */ new Map(), m = /* @__PURE__ */ new Set(), y = (u) => (typeof u == "string" && u.length > 0, d.has(u) ? d.get(u) : b2(u)), b2 = (u) => {
    if (u.startsWith("#")) {
...
var Ur = (t, e, n, s) => {
  ...
  const i = t.$qrl$.getFn(o, () => {
    r.$clearSub$(t);
  }), c = [], $3 = t.$state$, l = $e($3), a2 = { track: (p, S) => {
    if (V(p)) {
      const h = K();
      return h.$renderCtx$ = n, h.$subscriber$ = [0, t], W(h, p);
    }
    const g = F(p);
    return g ? g.$addSub$([0, t], S) : rn(Te(26), p), S ? p[S] : C(p) ? p.value : p;
  }, cleanup(p) {
    c.push(p);
  }, cache(p) {
    let S = 0;
    S = p === "immutable" ? 1 / 0 : p, $3._cache = S;
  }, previous: l._resolved };
  let f2, d, m = false;
  const y = (p, S) => !m && (m = true, p ? (m = true, $3.loading = false, $3._state = "resolved", $3._resolved = S, $3._error = void 0, f2(S)) : (m = true, $3.loading = false, $3._state = "rejected", $3._error = S, d(S)), true);
  W(o, () => {
    $3._state = "pending", $3.loading = !nt(), $3.value = new Promise((p, S) => {
      f2 = p, d = S;
    });
  }), t.$destroy$ = Fe(() => {
    m = true, c.forEach((p) => p());
  });
  const b2 = Ie(() => I(s, () => i(a2)), (p) => {
    y(true, p);
  }, (p) => {
    y(false, p);
  }), u = l._timeout;
  return u > 0 ? Promise.race([b2, Co(u).then(() => {
    ...
    if (s.$id$ = o, r) {
      ...
      if (Gr(t)) {
        ...
        if (a2) {
          ...
          if (d) {
            const [b2, u] = d.split(" ");
            if (s.$flags$ = Tn, b2 && (s.$componentQrl$ = i(b2)), u) {
              const p = i(u);
...
var ai = (t, e, n, s, o) => {
  let r = 0, i = 0, c = n.length - 1, $3 = n[0], l = n[c], a2 = s.length - 1, f2 = s[0], d = s[a2], m, y, b2;
  const u = [], p = t.$static$;
  for (; r <= c && i <= a2; )
    if ($3 == null)
      $3 = n[++r];
      ...
      if (m === void 0 && (m = Ei(n, r, c)), y = m[f2.$key$], y === void 0) {
        ...
        u.push(Rt(t, b2, f2, o)), n[y] = void 0, b2.$elm$, Nt(p, e, b2.$elm$, $3.$elm$);
      f2 = s[++i];
    }
  ...
  if (r !== Ct) {
    ...
    if (d || r !== "svg" || (s |= B, d = true), l !== O) {
      ...
      for (const y in l) {
        ...
        if (y !== "ref")
          if (un(y)) {
            const u = dn(f2.li, y, b2, c.$containerEl$);
            io(i, o, u);
          } else
            C(b2) && (b2 = it(b2, [1, $3.$element$, b2, o, y])), y === "class" ? b2 = mn(b2, $3) : y === "style" && (b2 = Pe(b2)), m[y] !== b2 && (m[y] = b2, Mn(i, o, y, b2, d));
        else
          b2 !== void 0 && kn(b2, o);
      }
    }
...
var bt = (t, e, n, s) => {
  ...
  if (o === "#signal") {
    ...
    {
      const S = r.createTextNode(e.$text$);
      return S.data = e.$text$ = Gt(p), it(u, 4 & n ? [3, S, u, S] : [4, i.$element$, u, S]), e.$elm$ = S;
    }
  }
  let c, $3 = !!(n & B);
  $3 || o !== "svg" || (n |= B, $3 = true);
  ...
  if (t.$slotCtx$ ? (m.$parentCtx$ = t.$slotCtx$, m.$realParentCtx$ = t.$cmpCtx$) : m.$parentCtx$ = t.$cmpCtx$, l) {
    if ("q:renderFn" in a2) {
      const u = a2["q:renderFn"], p = Ae(), S = d.$subsManager$.$createManager$(), g = new Proxy(p, new ys(d, S)), h = a2.props;
    ...
    if (e.$immutableProps$) {
      const u = a2 !== O ? Object.fromEntries(Object.entries(e.$immutableProps$).map(([p, S]) => [p, S === M ? a2[p] : S])) : e.$immutableProps$;
      es(f2, m, i, u, $3, true);
    }
    if (a2 !== O) {
      m.$vdom$ = e;
...
var Bi = async (t, e, n, s) => {
  ...
  for (const h of l) {
    ...
    if (w == null)
      break;
    b2.push(w.map((E3) => typeof E3 == "number" ? `_${E3}` : Oc(E3, f2)).filter(ps));
  }
  b2.length, m.size;
  const u = mo(l, d, f2, o, e), p = {}, S = {};
  for (const h of t) {
  ...
  return { state: { refs: S, ctx: p, objs: u, subs: b2 }, objs: l, funcs: o.$inlinedFunctions$, resources: o.$resources$, qrls: o.$qrls$, mode: c ? "render" : "listeners" };
};
var wt = (t, e, n) => {
  let s = "";
  for (const o of t) {
      ...
      return I(h, (w) => {
        if (V(w)) {
          if (p && p() === false)
            return;
          const E3 = { ...m(u), $qrl$: $3 };
          return E3.$event$ === void 0 && (E3.$event$ = this), Uc(e, E3.$element$, g), W.call(this, E3, w, ...S);
        }
        throw P(10);
      });
    };
  }
  const m = (u) => u == null ? K() : A(u) ? Js(u) : u, y = i ?? e, b2 = _o(y);
  return Object.assign($3, { getSymbol: () => y, getHash: () => b2, getCaptured: () => r, resolve: a2, $resolveLazy$: f2, $setContainer$: l, $chunk$: t, $symbol$: e, $refSymbol$: i, $hash$: b2, getFn: d, $capture$: o, $captureRef$: r, dev: null, resolved: e == "<sync>" ? n : void 0 }), $3;
};
var _o = (t) => {
    ...
    if (b2(), e[i] = () => {
      ...
      if (!e[s]) {
        if (e[a2] = false, clearTimeout(e[f2]), n !== location.pathname + location.search) {
          const S = t.closest("[q\\:container]").querySelector("a[q\\:link]");
          if (S) {
            const g = S.closest("[q\\:container]"), h = S.cloneNode();
      ...
      e[o] = true;
      const u = history.pushState, p = history.replaceState, S = (g) => (g === null || typeof g > "u" ? g = {} : (g == null ? void 0 : g.constructor) !== Object && (g = { _data: g }), g._qCityScroll = g._qCityScroll || y(), g);
      history.pushState = (g, h, w) => (g = S(g), u.call(history, g, h, w)), history.replaceState = (g, h, w) => (g = S(g), p.call(history, g, h, w));
    }
    e[c] = (u) => {
      ...
      if (p && !p.hasAttribute("preventdefault:click")) {
        const S = p.getAttribute("href"), g = new URL(location.href), h = new URL(S, g), w = h.origin === g.origin, E3 = h.pathname + h.search === g.pathname + g.search;
        if (w && E3)
          if (u.preventDefault(), h.href !== g.href && history.pushState(null, "", h), !h.hash)
            h.href.endsWith("#") ? window.scrollTo(0, 0) : (e[a2] = false, clearTimeout(e[f2]), b2({ ...y(), x: 0, y: 0 }), location.reload());
          else {
      ...
      !e[s] && e[a2] && document.visibilityState === "hidden" && b2();
    }, e[l] = () => {
...
var p$ = ({ track: t }) => {
  ...
  async function d() {
    const [y, b2] = t(() => [a2.value, e.value]), u = Zr(""), p = f2.url, S = b2 ? "form" : y.type;
    y.replaceState;
    let g, h, w = null;
    if (g = new URL(y.dest, f2.url), w = r.loadedRoute, h = r.response, w) {
      const [E3, x2, v3, _3] = w, q3 = v3, k2 = q3[q3.length - 1];
      f2.prevUrl = p, f2.url = g, f2.params = { ...x2 }, a2.untrackedValue = { type: S, dest: g };
...
// ../server/q-DmRSk70C.js
init_checked_fetch();
init_modules_watch_stub();
var be2 = ((t) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(t, { get: (e, n) => (typeof __require < "u" ? __require : e)[n] }) : t)(function(t) {
...
function G2(t, e) {
  ...
  return { isServer: true, async importSymbol(i, a2, o) {
    var _3;
    const c = z(o), d = (_3 = globalThis.__qwik_reg_symbols) == null ? void 0 : _3.get(c);
    if (d)
      return d;
    let m = String(a2);
    m.endsWith(".js") || (m += ".js");
    const q3 = be2(m);
    if (!(o in q3))
      throw new Error(`Q-ERROR: missing symbol '${o}' in module '${m}'.`);
    return q3[o];
...
function Qe2(t) {
  ...
  const s = (o, c) => {
    if (Array.isArray(o))
      for (const d of o) {
        const m = e.get(d.url) || 0;
        e.set(d.url, m + 1), n++, c.has(d.url) || (c.add(d.url), s(d.imports, c));
      }
  }, r = /* @__PURE__ */ new Set();
  for (const o of t)
...
function ze2(t, e, n) {
  const s = Be2(t == null ? void 0 : t.implementation), r = [];
  return s.prefetchEvent === "always" && Ce2(r, e, n), s.linkInsert === "html-append" && Se2(r, e, s), s.linkInsert === "js-append" ? Fe2(r, e, s, n) : s.workerFetchInsert === "always" && Ie2(r, e, n), r.length > 0 ? v$(he, { children: r }) : null;
}
function Ce2(t, e, n) {
  const s = Qe2(e);
  for (const r of s)
...
async function Le2(t, e) {
  var A3, K4, D3;
  let n = e.stream, s = 0, r = 0, i = 0, a2 = 0, o = "", c;
  const d = ((A3 = e.streaming) == null ? void 0 : A3.inOrder) ?? { strategy: "auto", maximunInitialChunk: 5e4, maximunChunk: 3e4 }, m = e.containerTagName ?? "html", q3 = e.containerAttributes ?? {}, _3 = n, se4 = Q2(), ie3 = ee2(e), p = ne2(e.manifest);
  function F4() {
  ...
  const re4 = Q2(), E3 = [];
  let T3 = 0, L4 = 0;
  await g$(t, { stream: n, containerTagName: m, containerAttributes: q3, serverData: e.serverData, base: ie3, beforeContent: x2, beforeClose: async (l, f2, O4, j3) => {
    var H4, M3, W4, U2, J4;
    T3 = re4();
    const b2 = Q2();
    ...
    if (e.prefetchStrategy !== null) {
      const w = xe2(c, e, p);
      if (w.length > 0) {
        const $3 = ze2(e.prefetchStrategy, w, (H4 = e.serverData) == null ? void 0 : H4.nonce);
        $3 && y.push($3);
      }
    }
    const ae4 = JSON.stringify(c.state, void 0, void 0);
    y.push(v$("script", { type: "qwik/json", dangerouslySetInnerHTML: Ae2(ae4), nonce: (M3 = e.serverData) == null ? void 0 : M3.nonce })), c.funcs.length > 0 && y.push(v$("script", { "q:func": "qwik/json", dangerouslySetInnerHTML: Oe2(c.funcs), nonce: (W4 = e.serverData) == null ? void 0 : W4.nonce }));
    const ce3 = !c || c.mode !== "static", R2 = k2 === "always" || k2 === "auto" && ce3;
    if (R2) {
      const w = Y2({ debug: e.debug });
      y.push(v$("script", { id: "qwikloader", dangerouslySetInnerHTML: w, nonce: (U2 = e.serverData) == null ? void 0 : U2.nonce }));
    }
    const P3 = Array.from(f2.$events$, (w) => JSON.stringify(w));
    if (P3.length > 0) {
      const w = (R2 ? "window.qwikevents" : "(window.qwikevents||=[])") + `.push(${P3.join(", ")})`;
      y.push(v$("script", { dangerouslySetInnerHTML: w, nonce: (J4 = e.serverData) == null ? void 0 : J4.nonce }));
    }
    return Ke2(E3, l), L4 = b2(), v$(he, { children: y });
  }, manifestHash: (p == null ? void 0 : p.manifest.manifestHash) || "dev" }), m !== "html" && n.write("<!--/cq-->"), F4();
  const oe4 = c.resources.some((l) => l._cache !== 1 / 0);
  return { prefetchResources: void 0, snapshotResult: c, flushes: i, manifest: p == null ? void 0 : p.manifest, size: r, isStatic: !oe4, timing: { render: T3, snapshot: L4, firstFlush: a2 }, _symbols: E3 };
}
function ne2(t) {
  if (t) {
    if ("mapper" in t)
...
var De2 = 'document.currentScript.closest("[q\\\\:container]").qFuncs=';
function Oe2(t) {
  return De2 + `[${t.join(`,
`)}]`;
}
...
var He2 = Qn(zt(Pe2, "s_0vphQYqOdZI"));
var Me2 = () => ft(R$, { children: [xt("head", null, null, [xt("meta", null, { charSet: "utf-8" }, null, 3, null), xt("link", null, { rel: "manifest", href: "/manifest.json" }, null, 3, null), ft(He2, null, 3, "vp_0")], 1, null), xt("body", null, { lang: "en" }, [ft(_$, null, 3, "vp_1"), ft(k$, null, 3, "vp_2")], 1, null)] }, 1, "vp_3");
var We2 = Qn(zt(Me2, "s_tntnak2DhJ8"));
function Ve2(t) {
  return Le2(ft(We2, null, 3, "Qb_0"), { manifest: Re2, ...t, containerAttributes: { lang: "en-us", ...t.containerAttributes } });
}
...
var C3 = ["flex", "w-full", "max-h-[100vh]", "justify-center", "overflow-hidden", "scrollbar-hidden"];
var O2 = ["p-4", "flex", "mt-4", "w-full", "flex-col", "h-screen", "rounded-md", "items-center", "shadow-border", "scrollbar-hidden"];
var Q3 = (e) => {
  const n = I$();
  return xt("div", { class: ["m-3", "flex", "rounded", "border-4", "items-center", "border-txtPrimary", "justify-center", "hover:bg-bgSecondary"] }, { onClick$: E$("s_lNnfZJK390A", [n, e]) }, y$((s) => s.icon, [e], "p0.icon"), 3, "tW_0");
};
var b = Qn(zt(Q3, "s_NCzEU0RO00k"));
...
var V2 = Qn(zt(T2, "s_Te3w2ykiWWU"));
var z2 = () => xt("div", { class: ["w-1/5", "flex", "flex-col", "justify-center", "max-w-[70px]"] }, null, [ft(b, { get icon() {
  return v$(A2, {});
}, [M]: { icon: M } }, 3, "Tj_0"), ft(b, { get icon() {
  return v$(V2, {});
}, link: "blog", [M]: { icon: M, link: M } }, 3, "Tj_1")], 1, "Tj_2");
var I2 = Qn(zt(z2, "s_PX8yQoK5ags"));
var N2 = async ({ cacheControl: e }) => {
  e({ staleWhileRevalidate: 604800, maxAge: 5 });
};
var R = () => xt("div", null, { class: C3 }, [xt("div", { class: [["w-1/5", "flex", "justify-end", "items-center", "sm:max-w-[70px]"], ["sm:hidden md:flex"]] }, null, null, 3, null), xt("div", { class: ["flex", "w-4/5", "h-full", "m-4"] }, null, xt("div", null, { class: O2 }, ft(xe, null, 3, "yB_0"), 1, null), 1, null), ft(I2, null, 3, "yB_1")], 1, "yB_2");
var W2 = Qn(zt(R, "s_VKFlAWJuVm8"));
var K2 = Object.freeze(Object.defineProperty({ __proto__: null, default: W2, onGet: N2 }, Symbol.toStringTag, { value: "Module" }));
...
_.setEndpoint(a.url);
var G3 = new Databases(_);
async function H2() {
  const e = await G3.listDocuments(a.databasesId, a.blogCollectionId);
  return console.log(e), e;
}
var E = (e) => {
  const n = I$(), i = ["p-2", "m-1", "flex", "flex-col", "max-w-sm", "rounded-2xl", "cursor-pointer", e.bgColor ? e.bgColor : "bg-transparent", "hover:bg-hover", "box-border", "shadow-border"], s = ["flex", "italic", "w-full", "text-2xl", "font-bold", "text-center", "select-none", "justify-center", e.txColor ? e.txColor : "text-txPrimary"], w = ["text-base", "mt-6", "select-none"];
  return xt("div", { class: i }, { onClick$: E$("s_kxX7fiVjwOg", [n, e]) }, [e.image ? xt("div", null, null, null, 3, "BN_0") : ft(he, null, 3, "BN_1"), xt("div", null, null, [xt("div", { class: s }, null, y$((u) => u.title, [e], "p0.title"), 3, null), xt("div", { class: w }, null, y$((u) => u.description, [e], "p0.description"), 3, null)], 1, null)], 1, e.key);
};
var L2 = Qn(zt(E, "s_Ckljc1FxMOo"));
var U = async () => {
  const [e] = wn();
  try {
    const i = (await H2()).documents.map((s) => ({ id: s.$id, title: s.title, overview: s.overview }));
    e.blogPosts = i;
  } catch (n) {
    console.error(n);
  }
...
var q = () => {
  ...
  return Qr(zt(U, "s_RJzQRezNotE", [e])), xt("div", null, null, e.blogPosts.length > 0 ? e.blogPosts.map((n) => ft(L2, { get title() {
    return n.title;
  }, get id() {
    return n.id;
  }, get description() {
...
var F2 = Qn(zt(q, "s_GBQBGBjVVwU"));
var J2 = { meta: [{ name: "Blog", content: "These are the blogs that I have uploaded" }] };
var $ = Object.freeze(Object.defineProperty({ __proto__: null, default: F2, head: J2 }, Symbol.toStringTag, { value: "Module" }));
var D2 = Object.freeze(Object.defineProperty({ __proto__: null }, Symbol.toStringTag, { value: "Module" }));
var Z2 = () => ft(he, { children: xt("div", null, { class: B2 }, "Site Under Construction", 3, null) }, 3, "Vi_0");
var X2 = Qn(zt(Z2, "s_uJ8rhQ0Ae0E"));
var Y3 = { title: "Welcome to Qwik", meta: [{ name: "description", content: "Qwik site description" }] };
var ee3 = Object.freeze(Object.defineProperty({ __proto__: null, default: X2, head: Y3 }, Symbol.toStringTag, { value: "Module" }));
var te3 = [];
var f = () => K2;
var ne3 = [["blog/", [f, () => $], "/blog/", ["q-G3wKS3o7.js", "q-D9qhhAhD.js"]], ["blog/[id]/", [f, () => D2], "/blog/[id]/", ["q-G3wKS3o7.js", "q-BZ_HFwgH.js"]], ["[...home]", [() => ee3], "/[...home]", ["q-lOMpOt_z.js"]]];
var oe2 = [];
var le2 = true;
var se2 = "/";
var re2 = true;
var ae2 = { routes: ne3, serverPlugins: te3, menus: oe2, trailingSlash: le2, basePathname: se2, cacheModules: re2 };
...
var Qe3 = class {
  constructor(e) {
    this[oe3] = {}, this[ce2] = {}, this[k] = He3(e), this[_2] = { ...this[k] };
  }
  get(e, t = true) {
...
var je3 = (e, t, n, r, a2) => {
  ...
  if (e && V3(i, s, o, e, l, n), t) {
    const c = t[0];
    r && (n === "POST" || n === "PUT" || n === "PATCH" || n === "DELETE") && o.unshift(Ye3), l && (n === "POST" && o.push(Xe2), o.push(Ge2), o.push(Ee3)), o.push(qe3), V3(i, s, o, t[2], l, n), l && (o.push((d) => {
...
var V3 = (e, t, n, r, a2, i) => {
  for (const s of r) {
    ...
    if (typeof o == "function" ? n.push(o) : Array.isArray(o) && n.push(...o), a2) {
      const l = Object.values(s).filter((d) => Y4(d, "server_loader"));
      e.push(...l);
      const c = Object.values(s).filter((d) => Y4(d, "server_action"));
      t.push(...c);
    }
  }
};
var Y4 = (e, t) => e && typeof e == "function" && e.__brand === t;
function Be3(e, t) {
  return async (n) => {
    if (n.headersSent) {
      n.exit();
    ...
    const { method: r } = n, a2 = I3(n), i = Q4(n) === "dev", s = n[L3];
...
Make sure your <form> has method="POST" attribute, like this: <form method="POST">`), r === "POST") {
    ...
    e.length > 0 && await Promise.all(e.map((o) => {
      const l = o.__id;
      return a2[l] = Z3(n, o.__validators, void 0, i).then((c) => c.success ? i ? N3(n, o.__qrl.getSymbol().split("_", 1)[0], () => o.__qrl.call(n, n)) : o.__qrl.call(n, n) : n.fail(c.status ?? 500, c.error)).then((c) => (typeof c == "function" ? a2[l] = c() : (i && O3(s, c, o.__qrl), a2[l] = c), c));
    }));
  };
}
async function Z3(e, t, n, r) {
  ...
  if (t)
    for (const i of t)
      if (r ? a2 = await N3(e, "validator$", () => i.validate(e, n)) : a2 = await i.validate(e, n), a2.success)
        n = a2.data;
      else
        return a2;
  return a2;
...
async function Xe2(e) {
  ...
  if (t && e.request.headers.get("X-QRL") === t && e.request.headers.get("Content-Type") === "application/qwik-json") {
    e.exit();
    const n = Q4(e) === "dev", r = e[L3], a2 = await e.parseBody();
    if (Array.isArray(a2)) {
      const [i, ...s] = a2;
...
function Ze2(e) {
  return async (t) => {
    ...
    try {
      const h = Q4(t) === "static", m = Fe3(t), u = await e({ base: t.basePathname + "build/", stream: c, serverData: m, containerAttributes: { "q:render": h ? "static" : "", ...m.containerAttributes } }), g = { loaders: I3(t), action: t.sharedMap.get(H3), status: d !== 200 ? d : 200, href: le3(t.url, a2) };
...
function it2(e, t, n, r, a2, i, s, o) {
  ...
  let w = -1, y = null, A3, T3 = e.locale, S = 200;
  const Se3 = async () => {
    for (w++; w < n.length; ) {
      const f2 = n[w], p = globalThis.qcAsyncRequestStore, b2 = p != null && p.run ? p.run(R2, f2, R2) : f2(R2);
      rt2(b2) && await b2, w++;
    }
  }, C4 = () => {
    if (y !== null)
    ...
    return U2();
  }, U2 = () => (w = E2, new B3()), z3 = {}, R2 = { [fe2]: z3, [ue2]: e.mode, [he2]: a2, [de2]: t, [L3]: s, cookie: m, headers: u, env: d, method: l.method, signal: l.signal, params: (t == null ? void 0 : t[1]) ?? {}, pathname: g.pathname, platform: c, query: g.searchParams, request: l, url: g, basePathname: i, sharedMap: h, get headersSent() {
    return y !== null;
  }, get exited() {
    return w >= E2;
  }, get clientConn() {
    ...
    if (f2.__brand === "server_loader" && !(p in z3))
      throw new Error("You can not get the returned data of a loader that has not been executed for this request.");
    return z3[p];
  }, status: (f2) => typeof f2 == "number" ? (C4(), S = f2, f2) : S, locale: (f2) => (typeof f2 == "string" && (T3 = f2), T3 || ""), error: (f2, p) => (S = f2, u.delete("Cache-Control"), new ie2(f2, p)), redirect: (f2, p) => {
    if (C4(), S = f2, p) {
  ...
  }, defer: (f2) => typeof f2 == "function" ? f2 : () => f2, fail: (f2, p) => (C4(), S = f2, u.delete("Cache-Control"), { failed: true, ...p }), text: (f2, p) => (u.set("Content-Type", "text/plain; charset=utf-8"), M3(f2, p)), html: (f2, p) => (u.set("Content-Type", "text/html; charset=utf-8"), M3(f2, p)), parseBody: async () => A3 !== void 0 ? A3 : A3 = ot2(R2.request, h, s), json: (f2, p) => (u.set("Content-Type", "application/json; charset=utf-8"), M3(f2, JSON.stringify(p))), send: M3, isDirty: () => y !== null, getWritableStream: () => {
    if (y === null) {
      if (e.mode === "dev") {
        const f2 = h.get("@serverTiming");
        f2 && u.set("Server-Timing", f2.map((p) => `${p[0]};dur=${p[1]}`).join(","));
      }
      y = e.getWritableStream(S, u, m, o, R2);
    }
    return y;
  } };
  ...
  async function n(r, a2, i) {
    try {
      ...
      const h = await wt2({ mode: "server", locale: void 0, url: s, request: r, env: { get(u) {
        ...
        const { readable: A3, writable: T3 } = new TransformStream(), S = new Response(A3, { status: u, headers: Ue2(g, w) });
        return y(S), T3;
...
var Pt2 = St2({ render: Ve2, qwikCityPlan: ae2, manifest: Re2 });
...
* found in the LICENSE file at https://github.com/BuilderIO/qwik/blob/main/LICENSE
*/
//# sourceMappingURL=bundledWorker-0.13412373568141822.mjs.map
